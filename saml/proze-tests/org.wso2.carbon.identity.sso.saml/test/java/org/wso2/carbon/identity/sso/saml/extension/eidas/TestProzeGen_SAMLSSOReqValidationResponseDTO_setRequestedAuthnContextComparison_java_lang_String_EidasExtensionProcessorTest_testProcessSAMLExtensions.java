...
public class TestProzeGen_SAMLSSOReqValidationResponseDTO_setRequestedAuthnContextComparison_java_lang_String_EidasExtensionProcessorTest_testProcessSAMLExtensions {
    ...
    public void testProcessSAMLExtensions(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        validationResp.setValid(true);
        validationResp.setForceAuthn(true);
        validationResp.setPassive(false);
        validationResp.setRequestedAuthnContextComparison(param0);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testProcessSAMLExtensions_1(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        validationResp.setValid(true);
        validationResp.setForceAuthn(true);
        validationResp.setPassive(false);
        validationResp.setRequestedAuthnContextComparison(param0);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testProcessSAMLExtensions_2(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        validationResp.setValid(true);
        validationResp.setForceAuthn(true);
        validationResp.setPassive(false);
        validationResp.setRequestedAuthnContextComparison(param0);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testProcessSAMLExtensions_3(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        validationResp.setValid(true);
        validationResp.setForceAuthn(true);
        validationResp.setPassive(false);
        validationResp.setRequestedAuthnContextComparison(param0);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testProcessSAMLExtensions_4(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        validationResp.setValid(true);
        validationResp.setForceAuthn(true);
        validationResp.setPassive(false);
        validationResp.setRequestedAuthnContextComparison(param0);
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"exact"},
        new java.lang.Object[]{"minimum"}
        };
    }
}
...
public class TestProzeGen_SAMLSSOUtil_setUserTenantDomain_java_lang_String_SAMLSSOUtilTest_testRemoveTenantDomain extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testRemoveTenantDomain(java.lang.String param0) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.setUserTenantDomain(param0);
        org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.removeUserTenantDomainThreaLocal();
        org.testng.Assert.assertNull(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.getUserTenantDomain(), "Tenant domain was removed. But still exists in the thread " + "local");
    }

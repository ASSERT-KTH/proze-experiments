...
public class TestProzeGen_SAMLSSOUtil_isSAMLNotOnOrAfterPeriodDefined_java_lang_String_AssertionBuildingTest_testisSAMLNotOnOrAfterPeriodDefined extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testisSAMLNotOnOrAfterPeriodDefined(java.lang.String param0) {
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), true, "Expected to return true for a numeric value.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to false false for a alphabetic value.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to return false for a zero.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to return false for a empty string.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to return false for white space.");
    }

    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testisSAMLNotOnOrAfterPeriodDefined_1(java.lang.String param0) {
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), true, "Expected to return true for a numeric value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ALPHA), false, "Expected to false false for a alphabetic value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ZERO), false, "Expected to return false for a zero.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_EMPTY), false, "Expected to return false for a empty string.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_WHITE_SPACE), false, "Expected to return false for white space.");
    }

    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testisSAMLNotOnOrAfterPeriodDefined_2(java.lang.String param0) {
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_NUMERIC), true, "Expected to return true for a numeric value.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to false false for a alphabetic value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ZERO), false, "Expected to return false for a zero.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_EMPTY), false, "Expected to return false for a empty string.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_WHITE_SPACE), false, "Expected to return false for white space.");
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testisSAMLNotOnOrAfterPeriodDefined_3(java.lang.String param0) {
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_NUMERIC), true, "Expected to return true for a numeric value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ALPHA), false, "Expected to false false for a alphabetic value.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to return false for a zero.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_EMPTY), false, "Expected to return false for a empty string.");
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testisSAMLNotOnOrAfterPeriodDefined_4(java.lang.String param0) {
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_NUMERIC), true, "Expected to return true for a numeric value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ALPHA), false, "Expected to false false for a alphabetic value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ZERO), false, "Expected to return false for a zero.");
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(param0), false, "Expected to return false for a empty string.");
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testisSAMLNotOnOrAfterPeriodDefined_5(java.lang.String param0) {
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_NUMERIC), true, "Expected to return true for a numeric value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ALPHA), false, "Expected to false false for a alphabetic value.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_ZERO), false, "Expected to return false for a zero.");
        // org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.isSAMLNotOnOrAfterPeriodDefined(org.wso2.carbon.identity.sso.saml.TestConstants.SAML_SESSION_NOT_ON_OR_AFTER_PERIOD_EMPTY), false, "Expected to return false for a empty string.");

...
public class TestProzeGen_SAMLSSOUtil_getX509CredentialImplForTenant_java_lang_String_java_lang_String_SAMLSSOUtilTest_testGetX509CredentialImplForTenant extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testGetX509CredentialImplForTenant(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        prepareForGetIssuer();
        prepareForGetKeyStorePath();
        org.powermock.api.mockito.PowerMockito.mockStatic(org.wso2.carbon.identity.application.authentication.framework.internal.FrameworkServiceComponent.class);
        org.powermock.api.mockito.PowerMockito.when(org.wso2.carbon.identity.application.authentication.framework.internal.FrameworkServiceComponent.getRealmService()).thenReturn(realmService);
        org.powermock.api.mockito.PowerMockito.when(realmService.getTenantManager()).thenReturn(tenantManager);
        org.powermock.api.mockito.PowerMockito.when(tenantManager.getTenantId(org.mockito.ArgumentMatchers.anyString())).thenReturn(1);
        org.powermock.api.mockito.PowerMockito.mockStatic(org.wso2.carbon.core.util.KeyStoreManager.class);
        org.powermock.api.mockito.PowerMockito.when(org.wso2.carbon.core.util.KeyStoreManager.getInstance(org.mockito.ArgumentMatchers.eq(1))).thenReturn(keyStoreManager);
        org.powermock.api.mockito.PowerMockito.when(keyStoreManager.getKeyStore(org.mockito.ArgumentMatchers.eq(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.generateKSNameFromDomainName(org.wso2.carbon.identity.sso.saml.TestConstants.WSO2_TENANT_DOMAIN)))).thenReturn(org.wso2.carbon.identity.sso.saml.TestUtils.loadKeyStoreFromFileSystem(org.wso2.carbon.identity.sso.saml.TestUtils.getFilePath(org.wso2.carbon.identity.sso.saml.TestConstants.KEY_STORE_NAME), org.wso2.carbon.identity.sso.saml.TestConstants.WSO2_CARBON, "JKS"));
        org.wso2.carbon.identity.sso.saml.builders.X509CredentialImpl x509Credential = org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.getX509CredentialImplForTenant(param0, param1);
        org.testng.Assert.assertNotNull(x509Credential.getPublicKey(), "public key is missing for tenant");
    }
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"carbon.super", "wso2carbon"},
        new java.lang.Object[]{"wso2.com", "wso2carbon"}
        };
    }
}
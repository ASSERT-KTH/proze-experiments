...
public class TestProzeGen_SAMLSSOUtil_setUserTenantDomain_java_lang_String_SAMLSSOUtilTest_testSetTenantDomain extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testSetTenantDomain(java.lang.String param0) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.setUserTenantDomain(param0);
        org.testng.Assert.assertEquals(org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.getUserTenantDomain(), org.wso2.carbon.identity.sso.saml.TestConstants.WSO2_TENANT_DOMAIN, "Didn't get back the tenant" + " domain which was set to");
    }

...
public class TestProzeGen_SAMLSSOUtil_getIssuerFromTenantDomain_java_lang_String_SAMLSSOUtilTest_testGetIssuerFromTenantDomain extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testGetIssuerFromTenantDomain(java.lang.String param0) throws java.lang.Exception {
        prepareForGetIssuer();
        ...
        org.testng.Assert.assertEquals(issuer.getValue(), org.wso2.carbon.identity.sso.saml.TestConstants.LOACALHOST_DOMAIN, "Issuer for Super tenant domain.");
    }

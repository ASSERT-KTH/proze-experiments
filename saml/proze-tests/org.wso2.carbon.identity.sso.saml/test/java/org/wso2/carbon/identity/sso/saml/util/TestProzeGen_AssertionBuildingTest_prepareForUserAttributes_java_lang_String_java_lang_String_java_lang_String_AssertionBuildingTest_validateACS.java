...
public class TestProzeGen_AssertionBuildingTest_prepareForUserAttributes_java_lang_String_java_lang_String_java_lang_String_AssertionBuildingTest_validateACS extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void validateACS(java.lang.String param0, java.lang.String param1, java.lang.String param2) throws java.lang.Exception {
        prepareForUserAttributes(org.wso2.carbon.identity.sso.saml.TestConstants.ATTRIBUTE_CONSUMER_INDEX, org.wso2.carbon.identity.sso.saml.TestConstants.TRAVELOCITY_ISSUER, org.wso2.carbon.identity.sso.saml.TestConstants.TRAVELOCITY_ISSUER);
        ...
        boolean isACSValied = org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.validateACS(org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME, org.wso2.carbon.identity.sso.saml.TestConstants.TRAVELOCITY_ISSUER, org.wso2.carbon.identity.sso.saml.TestConstants.ACS_URL);
        org.testng.Assert.assertTrue(isACSValied, "Expected to ACS to be validated. But failed");
    }

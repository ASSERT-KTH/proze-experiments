...
public class TestProzeGen_SSOSessionPersistenceManager_isExistingTokenId_java_lang_String_java_lang_String_SSOSessionPersistenceManagerTest_testIsExistingTokenId extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testIsExistingTokenId(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        java.lang.String sessionIndex = "sessionIndex";
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("sessionIndex", sessionIndex, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingTokenId(param0, param1), true);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache(sessionIndex, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingTokenId(param0, param1), false);
    }
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testIsExistingTokenId_1(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        java.lang.String sessionIndex = "sessionIndex";
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("sessionIndex", sessionIndex, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingTokenId(param0, param1), true);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache(sessionIndex, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        // org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingTokenId("sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME), false);
    }

    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testIsExistingTokenId_2(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        java.lang.String sessionIndex = "sessionIndex";
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("sessionIndex", sessionIndex, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        // org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingTokenId("sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME), true);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache(sessionIndex, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingTokenId(param0, param1), false);
    }
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"89da4f70-8f1e-45f7-a8f7-26b1100f7720-v2", "carbon.super"},

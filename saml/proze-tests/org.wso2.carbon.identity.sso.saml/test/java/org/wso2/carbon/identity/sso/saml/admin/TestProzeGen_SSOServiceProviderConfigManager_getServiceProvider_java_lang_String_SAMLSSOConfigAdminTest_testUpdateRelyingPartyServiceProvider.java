...
public class TestProzeGen_SSOServiceProviderConfigManager_getServiceProvider_java_lang_String_SAMLSSOConfigAdminTest_testUpdateRelyingPartyServiceProvider extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testUpdateRelyingPartyServiceProvider(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        ...
        org.powermock.api.mockito.PowerMockito.when(samlSSOServiceProviderManager.updateServiceProvider(org.mockito.ArgumentMatchers.any(org.wso2.carbon.identity.core.model.SAMLSSOServiceProviderDO.class), org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyInt())).thenReturn(true);
        ...
        org.testng.Assert.assertEquals(samlssoConfigAdmin.updateRelyingPartyServiceProvider(samlssoServiceProviderDTO, "testUser"), true);
        samlssoServiceProvDO = new org.wso2.carbon.identity.core.model.SAMLSSOServiceProviderDO();
        org.powermock.api.mockito.PowerMockito.when(ssoServiceProviderConfigManager.getServiceProvider(param0)).thenReturn(samlssoServiceProvDO);
        org.testng.Assert.assertEquals(samlssoConfigAdmin.updateRelyingPartyServiceProvider(samlssoServiceProviderDTO, "testUser"), false);
    }

    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testUpdateRelyingPartyServiceProvider_1(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        org.powermock.api.mockito.PowerMockito.mockStatic(org.wso2.carbon.identity.sso.saml.SSOServiceProviderConfigManager.class);
        org.powermock.api.mockito.PowerMockito.when(org.wso2.carbon.identity.sso.saml.SSOServiceProviderConfigManager.getInstance()).thenReturn(ssoServiceProviderConfigManager);
        org.powermock.api.mockito.PowerMockito.when(samlSSOServiceProviderManager.updateServiceProvider(org.mockito.ArgumentMatchers.any(org.wso2.carbon.identity.core.model.SAMLSSOServiceProviderDO.class), org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyInt())).thenReturn(true);
        org.wso2.carbon.identity.sso.saml.dto.SAMLSSOServiceProviderDTO samlssoServiceProviderDTO = new org.wso2.carbon.identity.sso.saml.dto.SAMLSSOServiceProviderDTO();
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testUpdateRelyingPartyServiceProvider_2(java.lang.String param0) throws org.wso2.carbon.identity.base.IdentityException {
        org.powermock.api.mockito.PowerMockito.mockStatic(org.wso2.carbon.identity.sso.saml.SSOServiceProviderConfigManager.class);
        org.powermock.api.mockito.PowerMockito.when(org.wso2.carbon.identity.sso.saml.SSOServiceProviderConfigManager.getInstance()).thenReturn(ssoServiceProviderConfigManager);
        org.powermock.api.mockito.PowerMockito.when(samlSSOServiceProviderManager.updateServiceProvider(org.mockito.ArgumentMatchers.any(org.wso2.carbon.identity.core.model.SAMLSSOServiceProviderDO.class), org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyInt())).thenReturn(true);
        org.wso2.carbon.identity.sso.saml.dto.SAMLSSOServiceProviderDTO samlssoServiceProviderDTO = new org.wso2.carbon.identity.sso.saml.dto.SAMLSSOServiceProviderDTO();
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"localhost"},
        ...
        new java.lang.Object[]{"travelocity.com:urn:qualifier:wso2.com"}
        };
    }
}
...
public class TestProzeGen_SAMLSSOUtil_getX509CredentialImplForTenant_java_lang_String_java_lang_String_SAMLSSOUtilTest_testGetX509CredentialImplForSuperTenant extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testGetX509CredentialImplForSuperTenant(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        prepareForGetIssuer();
        ...
        org.powermock.api.mockito.PowerMockito.when(org.wso2.carbon.core.util.KeyStoreManager.getInstance(org.mockito.ArgumentMatchers.eq(-1234))).thenReturn(keyStoreManager);
        org.powermock.api.mockito.PowerMockito.when(keyStoreManager.getPrimaryKeyStore()).thenReturn(org.wso2.carbon.identity.sso.saml.TestUtils.loadKeyStoreFromFileSystem(org.wso2.carbon.identity.sso.saml.TestUtils.getFilePath("wso2carbon.jks"), "wso2carbon", "JKS"));
        ...
        org.testng.Assert.assertNotNull(x509Credential.getPublicKey(), "public key is missing");
    }

...
public class TestProzeGen_SAMLTestRequestBuilder_buildAuthnRequest_java_lang_String_boolean_boolean_java_lang_String_java_lang_String_java_lang_String_AssertionBuildingTest_getSPInitAuthReqValidatorWithInvalidClass extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void getSPInitAuthReqValidatorWithInvalidClass(java.lang.String param0, boolean param1, boolean param2, java.lang.String param3, java.lang.String param4, java.lang.String param5) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.setSPInitSSOAuthnRequestValidator("org.wso2.carbon.identity.sso.saml.validators" + ".NonExistingClass");
        org.wso2.carbon.identity.saml.common.util.SAMLInitializer.doBootstrap();
        org.opensaml.saml.saml2.core.AuthnRequest authnRequest = org.wso2.carbon.identity.sso.saml.SAMLTestRequestBuilder.buildAuthnRequest(param0, param1, param2, param3, param4, param5);
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"travelocity.com", false, false, "GET", "travelocity.com", "https://localhost:9443/commonauth"},
        new java.lang.Object[]{"travelocity.com", false, false, "POST", "travelocity.com", "https://localhost:9443/commonauth"},
        new java.lang.Object[]{"travelocity.com", true, false, "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST", "http://localhost.com:8080/travelocity.com/home.jsp", "https://localhost:9443/samlsso"}
        };
    }
}
...
public class TestProzeGen_SAMLSSOParticipantCacheKey_init_SSOSessionPersistenceManagerTest_testAddSessionInfoDataToCache extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testAddSessionInfoDataToCache(java.lang.String param0) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SessionInfoData sessionInfoData = new org.wso2.carbon.identity.sso.saml.session.SessionInfoData();
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionId", sessionInfoData, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheKey(param0);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertNotNull(cacheEntry);
        org.wso2.carbon.identity.sso.saml.session.SessionInfoData actualSessionInfoData = cacheEntry.getSessionInfoData();
        org.testng.Assert.assertEquals(actualSessionInfoData, sessionInfoData);
    }
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testAddSessionInfoDataToCache_1(java.lang.String param0) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SessionInfoData sessionInfoData = new org.wso2.carbon.identity.sso.saml.session.SessionInfoData();
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionId", sessionInfoData, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheKey(param0);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testAddSessionInfoDataToCache_2(java.lang.String param0) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SessionInfoData sessionInfoData = new org.wso2.carbon.identity.sso.saml.session.SessionInfoData();
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionId", sessionInfoData, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheKey(param0);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOParticipantCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"45968110-dea2-49c2-a403-0aa402caa033"},
        new java.lang.Object[]{"614f4355-74cf-4e47-a05c-323b20812f1e"},
        new java.lang.Object[]{"86f3f0d4-60a5-4319-9bd8-2cc6c3a50eda"},
        new java.lang.Object[]{null},
        new java.lang.Object[]{"d5c336dc-0853-4010-855d-38d37b386832"},
        new java.lang.Object[]{"dddcd246-6f7d-46ea-a6cc-82df03a5e6f0"},
        new java.lang.Object[]{"samlTokenId"},
        new java.lang.Object[]{"sessionId"},
        new java.lang.Object[]{"sessionIndex"},
        new java.lang.Object[]{"sessionIndex1"},
        new java.lang.Object[]{"sessionIndex2"},
        new java.lang.Object[]{"sessionIndex3"},
        new java.lang.Object[]{"theSessionIndex"},
        new java.lang.Object[]{"theSessionIndexTwo"}
        };
    }
}
...
public class TestProzeGen_SAMLSSOUtil_getIssuerFromTenantDomain_java_lang_String_SAMLSSOUtilTest_testGetIssuerWhenEntityIDAliasEnabled extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testGetIssuerWhenEntityIDAliasEnabled(java.lang.String param0) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.setIssuerWithQualifierInThreadLocal(org.wso2.carbon.identity.sso.saml.TestConstants.ISSUER_WITH_QUALIFIER);
        prepareForGetIssuer();
        prepareForGetSPConfig();
        org.wso2.carbon.identity.sso.saml.TestUtils.startTenantFlow(org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.opensaml.saml.saml2.core.Issuer issuer = org.wso2.carbon.identity.sso.saml.util.SAMLSSOUtil.getIssuerFromTenantDomain(param0);

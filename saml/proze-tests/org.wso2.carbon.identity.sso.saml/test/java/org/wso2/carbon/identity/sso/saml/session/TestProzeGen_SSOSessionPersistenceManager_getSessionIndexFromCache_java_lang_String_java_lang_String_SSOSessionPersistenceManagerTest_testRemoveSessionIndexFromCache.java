...
public class TestProzeGen_SSOSessionPersistenceManager_getSessionIndexFromCache_java_lang_String_java_lang_String_SSOSessionPersistenceManagerTest_testRemoveSessionIndexFromCache extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testRemoveSessionIndexFromCache(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        ...
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache(null, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        sessionIndex = org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionIndexFromCache(param0, param1);
        org.testng.Assert.assertNotNull(sessionIndex);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache("sessionId", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        sessionIndex = org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionIndexFromCache(param0, param1);
        org.testng.Assert.assertNull(sessionIndex);
    }
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testRemoveSessionIndexFromCache_1(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        java.lang.String sessionIndex;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("sessionId", "sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache(null, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        sessionIndex = org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionIndexFromCache(param0, param1);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testRemoveSessionIndexFromCache_2(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        java.lang.String sessionIndex;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("sessionId", "sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionIndexFromCache(null, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        sessionIndex = org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionIndexFromCache(param0, param1);
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"sessionId2", "carbon.super"},
        new java.lang.Object[]{"sessionId3", "carbon.super"},

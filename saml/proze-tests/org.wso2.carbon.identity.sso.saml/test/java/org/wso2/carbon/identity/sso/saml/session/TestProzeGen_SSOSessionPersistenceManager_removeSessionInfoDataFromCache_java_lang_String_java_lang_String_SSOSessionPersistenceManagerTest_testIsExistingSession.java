...
public class TestProzeGen_SSOSessionPersistenceManager_removeSessionInfoDataFromCache_java_lang_String_java_lang_String_SSOSessionPersistenceManagerTest_testIsExistingSession extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testIsExistingSession(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        ...
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingSession("sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME), true);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache(param0, param1);
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingSession("sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME), false);
    }
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testIsExistingSession_1(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SessionInfoData sessionInfoData = new org.wso2.carbon.identity.sso.saml.session.SessionInfoData();
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionIndex", sessionInfoData, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingSession("sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME), true);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache(param0, param1);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testIsExistingSession_2(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SessionInfoData sessionInfoData = new org.wso2.carbon.identity.sso.saml.session.SessionInfoData();
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionIndex", sessionInfoData, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        // org.testng.Assert.assertEquals(ssoSessionPersistenceManager.isExistingSession("sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME), true);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache(param0, param1);

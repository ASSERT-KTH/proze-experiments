...
public class TestProzeGen_SSOSessionPersistenceManager_addSessionIndexToCache_java_lang_String_java_lang_String_java_lang_String_SSOSessionPersistenceManagerTest_testAddSessionIndexToCache extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testAddSessionIndexToCache(java.lang.String param0, java.lang.String param1, java.lang.String param2) throws java.lang.Exception {
        ...
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey("tokenid");
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testAddSessionIndexToCache_1(java.lang.String param0, java.lang.String param1, java.lang.String param2) throws java.lang.Exception {
        java.lang.String actualSessionIndex = null;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache(param0, param1, param2);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey("tokenid");
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testAddSessionIndexToCache_2(java.lang.String param0, java.lang.String param1, java.lang.String param2) throws java.lang.Exception {
        java.lang.String actualSessionIndex = null;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache(param0, param1, param2);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey("tokenid");
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);

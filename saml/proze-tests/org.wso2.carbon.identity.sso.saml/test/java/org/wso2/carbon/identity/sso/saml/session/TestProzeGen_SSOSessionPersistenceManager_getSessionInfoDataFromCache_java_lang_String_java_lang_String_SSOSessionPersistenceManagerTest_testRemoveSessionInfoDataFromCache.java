...
public class TestProzeGen_SSOSessionPersistenceManager_getSessionInfoDataFromCache_java_lang_String_java_lang_String_SSOSessionPersistenceManagerTest_testRemoveSessionInfoDataFromCache extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testRemoveSessionInfoDataFromCache(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionId", new org.wso2.carbon.identity.sso.saml.session.SessionInfoData(), org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache(null, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertNotNull(org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionInfoDataFromCache(param0, param1));
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache("sessionId", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertNull(org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionInfoDataFromCache(param0, param1));
    }
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testRemoveSessionInfoDataFromCache_1(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionId", new org.wso2.carbon.identity.sso.saml.session.SessionInfoData(), org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache(null, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertNotNull(org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionInfoDataFromCache(param0, param1));
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache("sessionId", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        // org.testng.Assert.assertNull(org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionInfoDataFromCache("sessionId", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME));
    }

    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testRemoveSessionInfoDataFromCache_2(java.lang.String param0, java.lang.String param1) throws java.lang.Exception {
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionInfoDataToCache("sessionId", new org.wso2.carbon.identity.sso.saml.session.SessionInfoData(), org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache(null, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        // org.testng.Assert.assertNotNull(org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionInfoDataFromCache("sessionId", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME));
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.removeSessionInfoDataFromCache("sessionId", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.testng.Assert.assertNull(org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.getSessionInfoDataFromCache(param0, param1));
    }

...
public class TestProzeGen_SAMLSSOSessionIndexCacheKey_init_SSOSessionPersistenceManagerTest_testAddSessionIndexToCache extends org.powermock.modules.testng.PowerMockTestCase {
    ...
    public void testAddSessionIndexToCache(java.lang.String param0) throws java.lang.Exception {
        java.lang.String actualSessionIndex = null;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("tokenid", "sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey(param0);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testAddSessionIndexToCache_1(java.lang.String param0) throws java.lang.Exception {
        java.lang.String actualSessionIndex = null;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("tokenid", "sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey(param0);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
    ...
    @org.testng.annotations.Test(dataProvider = "provideProzeArguments")
    public void testAddSessionIndexToCache_2(java.lang.String param0) throws java.lang.Exception {
        java.lang.String actualSessionIndex = null;
        org.wso2.carbon.identity.sso.saml.session.SSOSessionPersistenceManager.addSessionIndexToCache("tokenid", "sessionIndex", org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey cacheKey = new org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheKey(param0);
        org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCacheEntry cacheEntry = org.wso2.carbon.identity.sso.saml.cache.SAMLSSOSessionIndexCache.getInstance().getValueFromCache(cacheKey, org.wso2.carbon.utils.multitenancy.MultitenantConstants.SUPER_TENANT_DOMAIN_NAME);
    ...
    private static java.lang.Object[][] values() {
        ...
        new java.lang.Object[]{"39011ee9-4c05-4092-ac18-475ff558fb44-v2"},
        new java.lang.Object[]{"52a46bc3-9225-433d-9090-4b41a6ccbf7e-v2"},
        new java.lang.Object[]{"6f83baa2-2259-406e-ae70-9a0a57ccb37f-v2"},
        new java.lang.Object[]{"89da4f70-8f1e-45f7-a8f7-26b1100f7720-v2"},
        new java.lang.Object[]{null},
        new java.lang.Object[]{"a0e95eb5-eeec-4f94-b4b3-e5a59268e20e-v2"},
        new java.lang.Object[]{"samlssoToeknIdTwo"},
        new java.lang.Object[]{"samlssoTokenId"},
        new java.lang.Object[]{"sessionId"},
        new java.lang.Object[]{"sessionId1"},
        new java.lang.Object[]{"sessionId2"},
        new java.lang.Object[]{"sessionId3"},
        new java.lang.Object[]{"sessionIndex"},
        new java.lang.Object[]{"tokenid"}
        };
    }
}
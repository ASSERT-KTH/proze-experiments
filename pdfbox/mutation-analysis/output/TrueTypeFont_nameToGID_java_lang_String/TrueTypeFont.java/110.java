...
----> before:     private final List<String> enabledGsubFeatures = new ArrayList<String>();
----> after:     private final List<String> enabledGsubFeatures = null;
...
public class TrueTypeFont implements FontBoxFont, Closeable
{
    ...
    private final List<String> enabledGsubFeatures = null;

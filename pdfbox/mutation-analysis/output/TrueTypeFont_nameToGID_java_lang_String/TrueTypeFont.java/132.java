...
----> before:                     if (codePoint <= 0xD7FF || codePoint >= 0xE000) // disallowed code area
----> after:                     if (codePoint <= 0xD7FF && codePoint >= 0xE000) // disallowed code area
----> line number in original file: 650
----> mutated node: 4449

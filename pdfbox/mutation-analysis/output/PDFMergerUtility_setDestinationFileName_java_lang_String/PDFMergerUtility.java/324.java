...
----> before:         if (srcViewerPreferences.hideToolbar() || destViewerPreferences.hideToolbar())
----> after:         if (srcViewerPreferences.hideToolbar() && destViewerPreferences.hideToolbar())
----> line number in original file: 901
----> mutated node: 3279

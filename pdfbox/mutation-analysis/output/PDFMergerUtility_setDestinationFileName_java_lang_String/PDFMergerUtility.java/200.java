...
----> before:             destCatalog.addOutputIntent(new PDOutputIntent((COSDictionary) cloner.cloneForNewDocument(srcOI)));
----> after:             destCatalog.addOutputIntent(null);
----> line number in original file: 1226
----> mutated node: 9638
...
public class PDFMergerUtility
{
            ...
            PDDocumentCatalog srcCatalog, PDDocumentCatalog destCatalog) throws IOException
    {
        ...
        for (PDOutputIntent srcOI : srcOutputIntents)
        {
            ...
            destCatalog.addOutputIntent(null);

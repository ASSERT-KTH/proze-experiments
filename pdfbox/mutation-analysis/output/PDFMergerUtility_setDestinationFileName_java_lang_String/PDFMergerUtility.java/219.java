...
----> before:         Map<COSDictionary, COSDictionary> objMapping = new HashMap<COSDictionary, COSDictionary>();
----> after:         Map<COSDictionary, COSDictionary> objMapping = null;
----> line number in original file: 792
----> mutated node: 6573
...
public class PDFMergerUtility
{
    ...
    public void appendDocument(PDDocument destination, PDDocument source) throws IOException
    {
        ...
        Map<COSDictionary, COSDictionary> objMapping = null;
        int pageIndex = 0;

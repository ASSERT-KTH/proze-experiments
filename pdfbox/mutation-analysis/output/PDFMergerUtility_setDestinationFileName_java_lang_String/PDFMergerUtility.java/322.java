...
----> before:         if (srcViewerPreferences.hideWindowUI() || destViewerPreferences.hideWindowUI())
----> after:         if (srcViewerPreferences.hideWindowUI() && destViewerPreferences.hideWindowUI())
----> line number in original file: 909
----> mutated node: 3287

...
----> before:         if (destField.getFieldType() == "Tx" && destField.getFieldType() == "Tx")
----> after:         if (destField.getFieldType() == "Tx" && destField.getFieldType() != "Tx")
----> line number in original file: 1336
----> mutated node: 4247

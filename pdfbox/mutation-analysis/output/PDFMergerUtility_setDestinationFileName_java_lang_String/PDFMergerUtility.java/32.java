...
----> before:         if (dstKArray.size() == 1 && dstKArray.getObject(0) instanceof COSDictionary)
----> after:         if (dstKArray.size() != 1 && dstKArray.getObject(0) instanceof COSDictionary)
----> line number in original file: 994
----> mutated node: 4029

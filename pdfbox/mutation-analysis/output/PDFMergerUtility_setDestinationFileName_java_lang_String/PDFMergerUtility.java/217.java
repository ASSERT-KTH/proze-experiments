...
----> before:                 newPage.setResources(new PDResources((COSDictionary) cloner.cloneForNewDocument(resources)));
----> after:                 newPage.setResources(null);
----> line number in original file: 813
----> mutated node: 12242

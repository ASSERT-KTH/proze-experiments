...
----> before:                     destNums.add(cloner.cloneForNewDocument(srcNums.getObject(i + 1)));
----> after:                     destNums.add(cloner.cloneForNewDocument(srcNums.getObject(i - 1)));
----> line number in original file: 699
----> mutated node: 14952

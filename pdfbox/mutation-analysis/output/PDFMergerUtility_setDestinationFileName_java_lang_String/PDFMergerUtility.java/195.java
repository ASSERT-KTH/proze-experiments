...
----> before:         List<PDAnnotation> newannots = new ArrayList<PDAnnotation>(annots.size());
----> after:         List<PDAnnotation> newannots = null;
----> line number in original file: 1619
----> mutated node: 7082
...
public class PDFMergerUtility
{
    ...
    private void updateStructParentEntries(PDPage page, int structParentOffset) throws IOException
    {
        ...
        List<PDAnnotation> newannots = null;

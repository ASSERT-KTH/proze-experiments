...
----> before:         if (srcViewerPreferences.centerWindow() || destViewerPreferences.centerWindow())
----> after:         if (srcViewerPreferences.centerWindow() && destViewerPreferences.centerWindow())
----> line number in original file: 917
----> mutated node: 3295

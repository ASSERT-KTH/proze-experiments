...
----> before:         else if (documentMergeMode == DocumentMergeMode.OPTIMIZE_RESOURCES_MODE)
----> after:         else if (documentMergeMode != DocumentMergeMode.OPTIMIZE_RESOURCES_MODE)
----> line number in original file: 348
----> mutated node: 3662

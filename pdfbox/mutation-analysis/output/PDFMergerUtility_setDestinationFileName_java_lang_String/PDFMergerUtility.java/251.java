...
----> before:             if (destValue != null && destValue.equals(entry.getValue()))
----> after:             if (true && destValue.equals(entry.getValue()))
----> line number in original file: 1183
----> mutated node: 7831
...
public class PDFMergerUtility
{
    ...
    private void mergeRoleMap(PDStructureTreeRoot srcStructTree, PDStructureTreeRoot destStructTree)
    {
        ...
        for (Map.Entry<COSName, COSBase> entry : srcDict.entrySet())
        {
            ...
            if (true && destValue.equals(entry.getValue()))
            {

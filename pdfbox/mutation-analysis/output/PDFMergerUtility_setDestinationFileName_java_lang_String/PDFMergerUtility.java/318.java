...
----> before:         destMark.setSuspect(srcMark.isSuspect() || destMark.isSuspect());
----> after:         destMark.setSuspect(srcMark.isSuspect() && destMark.isSuspect());
----> line number in original file: 952
----> mutated node: 4856

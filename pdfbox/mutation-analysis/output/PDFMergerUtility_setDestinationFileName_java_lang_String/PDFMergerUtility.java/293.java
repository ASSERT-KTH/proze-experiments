...
----> before:         if (destNames != null && destNames.getCOSObject().containsKey(COSName.ID_TREE))
----> after:         if (true && destNames.getCOSObject().containsKey(COSName.ID_TREE))
...
public class PDFMergerUtility
{
    ...
    public void appendDocument(PDDocument destination, PDDocument source) throws IOException
    {
        ...
        if (true && destNames.getCOSObject().containsKey(COSName.ID_TREE))
        {

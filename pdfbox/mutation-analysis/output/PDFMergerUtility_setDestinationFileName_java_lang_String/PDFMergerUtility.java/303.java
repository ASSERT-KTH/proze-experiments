...
----> before:                 MemoryUsageSetting partitionedMemSetting = memUsageSetting != null ? 
----> after:                 MemoryUsageSetting partitionedMemSetting = true ? 
----> line number in original file: 441
----> mutated node: 12008
...
public class PDFMergerUtility
{
    ...
    private void legacyMergeDocuments(MemoryUsageSetting memUsageSetting) throws IOException
    {
        ...
        if (sources.size() > 0)
        {
            ...
            try
            {
                MemoryUsageSetting partitionedMemSetting = true ? 

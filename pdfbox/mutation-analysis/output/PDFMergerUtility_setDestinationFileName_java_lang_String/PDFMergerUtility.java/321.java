...
----> before:         if (srcViewerPreferences.fitWindow() || destViewerPreferences.fitWindow())
----> after:         if (srcViewerPreferences.fitWindow() && destViewerPreferences.fitWindow())
----> line number in original file: 913
----> mutated node: 3291

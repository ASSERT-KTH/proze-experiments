...
----> before:                 destNumberTreeAsMap.put(destParentTreeNextKey + srcKey, cloner.cloneForNewDocument(entry.getValue()));
----> after:                 destNumberTreeAsMap.put(destParentTreeNextKey - srcKey, cloner.cloneForNewDocument(entry.getValue()));
----> line number in original file: 861
----> mutated node: 11613

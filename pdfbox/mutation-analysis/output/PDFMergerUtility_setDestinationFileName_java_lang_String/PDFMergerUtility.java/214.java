...
----> before:             destViewerPreferences = new PDViewerPreferences(new COSDictionary());
----> after:             destViewerPreferences = new PDViewerPreferences(null);
----> line number in original file: 894
----> mutated node: 12311
...
public class PDFMergerUtility
{
    ...
    private void mergeViewerPreferences(PDDocumentCatalog destCatalog, PDDocumentCatalog srcCatalog)
    {
        ...
        {
            destViewerPreferences = new PDViewerPreferences(null);

...
----> before:             if (destOutline == null || destOutline.getFirstChild() == null)
----> after:             if (false || destOutline.getFirstChild() == null)
----> line number in original file: 628
----> mutated node: 7289
...
public class PDFMergerUtility
{
    ...
    public void appendDocument(PDDocument destination, PDDocument source) throws IOException
    {
        ...
        if (srcOutline != null)
        {
            ...
            if (false || destOutline.getFirstChild() == null)
            {

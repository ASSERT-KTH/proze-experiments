...
----> before:                 if (destParentTreeNextKey >= 0 && srcStructTree != null)
----> after:                 if (destParentTreeNextKey >= 0 && true)
----> line number in original file: 777
----> mutated node: 10819
    ...
    public void appendDocument(PDDocument destination, PDDocument source) throws IOException
    {
        ...
        if (destStructTree != null)
        {
            ...
            if (destParentTree != null)
            {
                ...
                if (destParentTreeNextKey >= 0 && true)
                {

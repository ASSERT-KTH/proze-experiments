...
----> before:                     destNums.add(COSInteger.get(labelIndexValue + destPageCount));
----> after:                     destNums.add(COSInteger.get(labelIndexValue - destPageCount));
----> line number in original file: 698
----> mutated node: 14445

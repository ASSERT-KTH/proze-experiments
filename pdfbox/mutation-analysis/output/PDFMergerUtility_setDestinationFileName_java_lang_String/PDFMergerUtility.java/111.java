...
----> before:             if (!COSName.DOCUMENT.equals(dict.getCOSName(COSName.S)) &&
----> after:             if ( COSName.DOCUMENT.equals(dict.getCOSName(COSName.S)) &&
----> line number in original file: 1045
----> mutated node: 7715

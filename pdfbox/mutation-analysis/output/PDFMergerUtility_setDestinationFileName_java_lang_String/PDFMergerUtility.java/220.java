...
----> before:             destStructTree.setParentTree(new PDNumberTreeNode(PDParentTreeValue.class));
----> after:             destStructTree.setParentTree(null);
----> line number in original file: 748
----> mutated node: 9259
...
public class PDFMergerUtility
{
    ...
    public void appendDocument(PDDocument destination, PDDocument source) throws IOException
    {
        ...
        if (destStructTree == null && srcStructTree != null)
        {
            ...
            destStructTree.setParentTree(null);

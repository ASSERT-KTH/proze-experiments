...
----> before:         if (documentMergeMode == DocumentMergeMode.PDFBOX_LEGACY_MODE)
----> after:         if (documentMergeMode != DocumentMergeMode.PDFBOX_LEGACY_MODE)
----> line number in original file: 344
----> mutated node: 3102

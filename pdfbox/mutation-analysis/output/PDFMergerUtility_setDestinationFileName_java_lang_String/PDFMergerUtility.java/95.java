...
----> before:             page.setStructParents(page.getStructParents() + structParentOffset);
----> after:             page.setStructParents(page.getStructParents() - structParentOffset);
----> line number in original file: 1616
----> mutated node: 8977

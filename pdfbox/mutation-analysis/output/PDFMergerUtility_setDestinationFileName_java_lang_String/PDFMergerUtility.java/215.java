...
----> before:             PDNumberTreeNode newParentTreeNode = new PDNumberTreeNode(PDParentTreeValue.class);
----> after:             PDNumberTreeNode newParentTreeNode = null;
----> line number in original file: 864
----> mutated node: 10163
...
public class PDFMergerUtility
{
    ...
    public void appendDocument(PDDocument destination, PDDocument source) throws IOException
    {
        ...
        if (mergeStructTree)
        {
            ...
            PDNumberTreeNode newParentTreeNode = null;

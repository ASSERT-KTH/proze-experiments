...
----> before:                 return new String(bytes, 2, bytes.length - 2, Charsets.UTF_16BE);
----> after:                 return new String(bytes, 2, bytes.length + 2, Charsets.UTF_16BE);
----> line number in original file: 188
----> mutated node: 1549

...
----> before:                 bytes.write(Integer.parseInt(hexBuffer.substring(i, i + 2), 16));
----> after:                 bytes.write(Integer.parseInt(hexBuffer.substring(i, i - 2), 16));
----> line number in original file: 125
----> mutated node: 1567

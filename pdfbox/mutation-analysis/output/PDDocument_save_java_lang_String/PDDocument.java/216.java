...
----> before:             acroForm.getCOSObject().setItem(COSName.FIELDS, new COSArray());
----> after:             acroForm.getCOSObject().setItem(COSName.FIELDS, null);
----> line number in original file: 404
----> mutated node: 9193
...
public class PDDocument implements Closeable
{
                             ...
                             SignatureOptions options) throws IOException
    {
        ...
        {
            acroForm.getCOSObject().setItem(COSName.FIELDS, null);
        }

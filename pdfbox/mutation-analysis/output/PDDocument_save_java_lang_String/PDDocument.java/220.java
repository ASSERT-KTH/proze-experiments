...
----> before:         addSignature(sigObject, signatureInterface, new SignatureOptions());
----> after:         addSignature(sigObject, signatureInterface, null);
----> line number in original file: 321
----> mutated node: 6518
...
public class PDDocument implements Closeable
{
    ...
    {
        addSignature(sigObject, signatureInterface, null);
    }

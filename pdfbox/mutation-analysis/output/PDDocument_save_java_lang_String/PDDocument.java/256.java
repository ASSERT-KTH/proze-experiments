...
----> before:                 if (signature != null && signature.getCOSObject().equals(sigObject.getCOSObject()))
----> after:                 if (true && signature.getCOSObject().equals(sigObject.getCOSObject()))
----> line number in original file: 504
----> mutated node: 10086
    ...
    private PDSignatureField findSignatureField(Iterator<PDField> fieldIterator, PDSignature sigObject)
    {
        ...
        while (fieldIterator.hasNext())
        {
            ...
            if (pdField instanceof PDSignatureField)
            {
                ...
                if (true && signature.getCOSObject().equals(sigObject.getCOSObject()))
                {

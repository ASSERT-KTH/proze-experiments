...
----> before:         importedPage.setCropBox(new PDRectangle(page.getCropBox().getCOSArray()));
----> after:         importedPage.setCropBox(null);
----> line number in original file: 778
----> mutated node: 6806

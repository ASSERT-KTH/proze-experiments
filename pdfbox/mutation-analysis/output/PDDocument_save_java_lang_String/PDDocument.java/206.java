...
----> before:         PDPage importedPage = new PDPage(new COSDictionary(page.getCOSObject()), resourceCache);
----> after:         PDPage importedPage = new PDPage(null, resourceCache);
----> line number in original file: 774
----> mutated node: 10209
...
public class PDDocument implements Closeable
{
    ...
    {
        PDPage importedPage = new PDPage(null, resourceCache);

...
----> before:         int startIndex = Math.min(Math.max(options.getPage(), 0), pageCount - 1);
----> after:         int startIndex = Math.min(Math.max(options.getPage(), 0), pageCount + 1);
----> line number in original file: 376
----> mutated node: 7939

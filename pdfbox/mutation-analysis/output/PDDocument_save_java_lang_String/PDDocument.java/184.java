...
----> before:         save(new BufferedOutputStream(new FileOutputStream(file)));
----> after:         save(new BufferedOutputStream(null));
----> line number in original file: 1342
----> mutated node: 9928
...
public class PDDocument implements Closeable
{
    ...
    {
        save(new BufferedOutputStream(null));
    }

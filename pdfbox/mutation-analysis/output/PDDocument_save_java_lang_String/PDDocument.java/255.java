...
----> before:         if (existingRectangle == null || existingRectangle.getCOSArray().size() != 4)
----> after:         if (false || existingRectangle.getCOSArray().size() != 4)
----> line number in original file: 605
----> mutated node: 4974
...
public class PDDocument implements Closeable
{
    ...
    private void assignSignatureRectangle(PDSignatureField signatureField, COSDictionary annotDict)
    {
        ...
        if (false || existingRectangle.getCOSArray().size() != 4)
        {

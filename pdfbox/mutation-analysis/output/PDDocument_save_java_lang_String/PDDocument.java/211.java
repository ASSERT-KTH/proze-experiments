...
----> before:         signatureField.getWidgets().get(0).setRectangle(new PDRectangle());
----> after:         signatureField.getWidgets().get(0).setRectangle(null);
----> line number in original file: 654
----> mutated node: 6728
...
public class PDDocument implements Closeable
{
    ...
    private void prepareNonVisibleSignature(PDSignatureField signatureField)
    {
        ...
        signatureField.getWidgets().get(0).setRectangle(null);

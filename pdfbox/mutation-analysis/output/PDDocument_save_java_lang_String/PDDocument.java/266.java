...
----> before:                 if (sigFieldNotFound && COSName.SIG.equals(fieldType) && apDict instanceof COSDictionary)
----> after:                 if (sigFieldNotFound || COSName.SIG.equals(fieldType) && apDict instanceof COSDictionary)
----> line number in original file: 583
----> mutated node: 10124

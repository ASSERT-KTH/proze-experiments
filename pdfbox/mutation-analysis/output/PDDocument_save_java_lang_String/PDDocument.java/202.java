...
----> before:         importedPage.setMediaBox(new PDRectangle(page.getMediaBox().getCOSArray()));
----> after:         importedPage.setMediaBox(null);
----> line number in original file: 779
----> mutated node: 6809

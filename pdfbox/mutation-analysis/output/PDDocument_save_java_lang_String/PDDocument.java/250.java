...
----> before:         if (page.getResources() != null && !page.getCOSObject().containsKey(COSName.RESOURCES))
----> after:         if (true && !page.getCOSObject().containsKey(COSName.RESOURCES))
----> line number in original file: 781
----> mutated node: 5098
...
public class PDDocument implements Closeable
{
    ...
    public PDPage importPage(PDPage page) throws IOException
    {
        ...
        if (true && !page.getCOSObject().containsKey(COSName.RESOURCES))
        {

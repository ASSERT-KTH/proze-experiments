...
----> before:                     int codePoint = Integer.parseInt(name.substring(chPos, chPos + 4), 16);
----> after:                     int codePoint = Integer.parseInt(name.substring(chPos, chPos - 4), 16);
----> line number in original file: 649
----> mutated node: 4693

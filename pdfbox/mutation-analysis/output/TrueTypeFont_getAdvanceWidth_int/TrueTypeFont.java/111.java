...
----> before:     protected Map<String,TTFTable> tables = new HashMap<String,TTFTable>();
----> after:     protected Map<String,TTFTable> tables = null;
...
public class TrueTypeFont implements FontBoxFont, Closeable
{
    ...
    protected Map<String,TTFTable> tables = null;

...
public class TestProzeGen_XMPSchema_getUnqualifiedTextPropertyValue_java_lang_String_XMPSchemaTest_testProperties {
    ...
    public void testProperties(String param0) throws Exception {
        ...
        assertEquals(textPropVal, schem.getUnqualifiedTextPropertyValue(param0));

...
public class TestProzeGen_PDOptionalContentProperties_isGroupEnabled_java_lang_String_TestOptionalContentGroups_testOCGConsumption {
    private static final java.io.File testResultsDir = new java.io.File("target/test-output");

    @org.junit.jupiter.api.BeforeAll
    public static void setUp() throws Exception {
        // super.setUp();
        TestProzeGen_PDOptionalContentProperties_isGroupEnabled_java_lang_String_TestOptionalContentGroups_testOCGConsumption.testResultsDir.mkdirs();
    }
    ...
    public void testOCGConsumption(String param0) throws Exception {
        java.io.File pdfFile = new java.io.File(TestProzeGen_PDOptionalContentProperties_isGroupEnabled_java_lang_String_TestOptionalContentGroups_testOCGConsumption.testResultsDir, "ocg-generation.pdf");
        if (!pdfFile.exists()) {
            testOCGGeneration();
        }
        ...
        try {
            ...
            assertTrue(ocgs.isGroupEnabled(param0));
            assertTrue(ocgs.isGroupEnabled(param0));
            assertFalse(ocgs.isGroupEnabled(param0));

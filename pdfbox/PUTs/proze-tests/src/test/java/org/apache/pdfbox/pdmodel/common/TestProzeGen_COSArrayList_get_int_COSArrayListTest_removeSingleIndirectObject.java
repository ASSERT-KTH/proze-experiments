...
public class TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject {
    ...
    public void setUp() throws Exception {
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsArray.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsArray.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsArray.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsArray.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.pdPage.setAnnotations(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.annotationsList);
        // create test output directory
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeSingleIndirectObject(int param0) throws java.io.IOException {
        ...
        pdf.save(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.OUT_DIR + "/removeSingleIndirectObjectTest.pdf");
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleIndirectObject.OUT_DIR + "/removeSingleIndirectObjectTest.pdf"));
        page = pdf.getPage(0);

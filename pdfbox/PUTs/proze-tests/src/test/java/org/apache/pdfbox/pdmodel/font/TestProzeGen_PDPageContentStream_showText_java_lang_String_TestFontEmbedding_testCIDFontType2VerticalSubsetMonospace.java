...
public class TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    // @Override
    @org.junit.jupiter.api.BeforeAll
    public static void setUp() throws Exception {
        TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR.mkdirs();
    }
    ...
    public void testCIDFontType2VerticalSubsetMonospace(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2VM.pdf");
        ...
        java.io.File ipafont = new java.io.File("target/fonts/ipag00303", "ipag.ttf");
    ...
    private void validateCIDFontType2(boolean useSubset) throws Exception {
        ...
        stream.endText();
        stream.close();
        java.io.File file = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2.pdf");
        document.save(file);
        document.close();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetMonospace_1(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2VM.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetMonospace_2(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2VM.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetMonospace_3(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2VM.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetMonospace_4(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2VM.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetMonospace_5(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetMonospace.OUT_DIR, "CIDFontType2VM.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();

 ...
 */
public class TestProzeGen_ProtectionPolicy_setEncryptionKeyLength_int_TestPublicKeyEncryption_testProtection {
    ...
    public TestProzeGen_ProtectionPolicy_setEncryptionKeyLength_int_TestPublicKeyEncryption_testProtection() {
    ...
    public void testProtection(int param0) throws Exception {
        ...
        java.io.File file = save("testProtection");
        org.apache.pdfbox.pdmodel.PDDocument encryptedDoc = reload(file, password1, getKeyStore(keyStore1));
        try {
            assertTrue(encryptedDoc.isEncrypted());
            org.apache.pdfbox.pdmodel.encryption.AccessPermission permission = encryptedDoc.getCurrentAccessPermission();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_1(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_2(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_3(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_4(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_5(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_6(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_7(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_8(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrintDegraded());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testProtection_9(int param0) throws Exception {
        org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy policy = new org.apache.pdfbox.pdmodel.encryption.PublicKeyProtectionPolicy();
        policy.addRecipient(recipient1);
        policy.setEncryptionKeyLength(param0);
        document.protect(policy);
...
//            assertFalse(permission.canPrint());
    ...
    private org.apache.pdfbox.pdmodel.encryption.PublicKeyRecipient getRecipient(String certificate, org.apache.pdfbox.pdmodel.encryption.AccessPermission permission) throws Exception {
        java.io.InputStream input = TestProzeGen_ProtectionPolicy_setEncryptionKeyLength_int_TestPublicKeyEncryption_testProtection.class.getResourceAsStream(certificate);
        try {
    ...
    private java.io.InputStream getKeyStore(String name) {
        return TestProzeGen_ProtectionPolicy_setEncryptionKeyLength_int_TestPublicKeyEncryption_testProtection.class.getResourceAsStream(name);
    }

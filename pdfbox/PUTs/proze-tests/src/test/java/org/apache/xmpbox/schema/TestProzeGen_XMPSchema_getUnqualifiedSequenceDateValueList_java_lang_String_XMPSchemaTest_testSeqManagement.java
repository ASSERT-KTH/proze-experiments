...
public class TestProzeGen_XMPSchema_getUnqualifiedSequenceDateValueList_java_lang_String_XMPSchemaTest_testSeqManagement {
    ...
    public void testSeqManagement(String param0) throws Exception {
        ...
        java.util.List<java.util.Calendar> dates = schem.getUnqualifiedSequenceDateValueList(param0);
        ...
        assertEquals(0, schem.getUnqualifiedSequenceDateValueList(param0).size());

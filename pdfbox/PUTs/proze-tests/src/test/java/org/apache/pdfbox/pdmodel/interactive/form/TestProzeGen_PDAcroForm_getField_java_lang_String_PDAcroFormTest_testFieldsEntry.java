 ...
 */
public class TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormTest_testFieldsEntry {
    ...
    public void testFieldsEntry(java.lang.String param0) {
        assertNotNull(acroForm.getFields());
        assertEquals(0, acroForm.getFields().size());
        assertNull(acroForm.getField(param0));
        acroForm.getCOSObject().removeItem(org.apache.pdfbox.cos.COSName.FIELDS);
        assertNotNull(acroForm.getFields());
        assertEquals(0, acroForm.getFields().size());
        assertNull(acroForm.getField(param0));
    }
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFieldsEntry_1(java.lang.String param0) {
        assertNotNull(acroForm.getFields());
        // assertEquals(0, acroForm.getFields().size());
...
//        assertNotNull(acroForm.getFields());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFieldsEntry_2(java.lang.String param0) {
        // assertNotNull(acroForm.getFields());
        assertEquals(0, acroForm.getFields().size());
        // assertNull(acroForm.getField("foo"));
        acroForm.getCOSObject().removeItem(org.apache.pdfbox.cos.COSName.FIELDS);
...
//        assertEquals(0, acroForm.getFields().size());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFieldsEntry_3(java.lang.String param0) {
        // assertNotNull(acroForm.getFields());
        // assertEquals(0, acroForm.getFields().size());
        assertNull(acroForm.getField(param0));
        acroForm.getCOSObject().removeItem(org.apache.pdfbox.cos.COSName.FIELDS);
...
//        assertNull(acroForm.getField(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFieldsEntry_4(java.lang.String param0) {
//        assertNotNull(acroForm.getFields());
        // assertEquals(0, acroForm.getFields().size());
        // assertNull(acroForm.getField("foo"));
        acroForm.getCOSObject().removeItem(org.apache.pdfbox.cos.COSName.FIELDS);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFieldsEntry_5(java.lang.String param0) {
        // assertNotNull(acroForm.getFields());
//        assertEquals(0, acroForm.getFields().size());
        // assertNull(acroForm.getField("foo"));
        acroForm.getCOSObject().removeItem(org.apache.pdfbox.cos.COSName.FIELDS);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFieldsEntry_6(java.lang.String param0) {
        // assertNotNull(acroForm.getFields());
        // assertEquals(0, acroForm.getFields().size());
//        assertNull(acroForm.getField(param0));
        acroForm.getCOSObject().removeItem(org.apache.pdfbox.cos.COSName.FIELDS);

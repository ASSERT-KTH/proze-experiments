...
public class TestProzeGen_PDAcroForm_getField_java_lang_String_TestFields_testAcroFormsBasicFields {
    ...
    public void testAcroFormsBasicFields(String param0) throws IOException {
        ...
        try {
            doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDAcroForm_getField_java_lang_String_TestFields_testAcroFormsBasicFields.PATH_OF_PDF));
            // get and assert that there is a form
            PDAcroForm form = doc.getDocumentCatalog().getAcroForm();
            assertNotNull(form);
            // assert that there is no value, set the field value and
            // ensure it has been set
            PDTextField textField = ((PDTextField) (form.getField(param0)));
            ...
            textField = ((PDTextField) (form.getField(param0)));

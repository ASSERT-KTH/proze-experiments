...
public class TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject {
    ...
    public void setUp() throws Exception {
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.pdPage.setAnnotations(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.annotationsList);
        // create test output directory
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeSingleDirectObject(int param0) throws java.io.IOException {
        ...
        pdf.save(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.OUT_DIR + "/removeSingleDirectObjectTest.pdf");
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeSingleDirectObject.OUT_DIR + "/removeSingleDirectObjectTest.pdf"));
        page = pdf.getPage(0);

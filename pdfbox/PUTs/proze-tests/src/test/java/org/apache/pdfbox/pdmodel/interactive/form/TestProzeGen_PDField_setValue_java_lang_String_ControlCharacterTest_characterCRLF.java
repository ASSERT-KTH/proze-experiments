 ...
 */
public class TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterCRLF {
    ...
    public void setUp() throws java.io.IOException {
        document = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterCRLF.IN_DIR, TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterCRLF.NAME_OF_PDF));
    ...
    public void characterCRLF(String param0) throws java.io.IOException {
        ...
        java.util.List<String> acrobatValues = getStringsFromStream(acroForm.getField("acrobat-crlf"));

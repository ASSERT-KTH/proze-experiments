 ...
 */
public class TestProzeGen_DublinCoreSchema_addSubject_java_lang_String_TestSynchronizedMetadataValidation_testNullArrayValue {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_DublinCoreSchema_addSubject_java_lang_String_TestSynchronizedMetadataValidation_testNullArrayValue.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testNullArrayValue(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_DublinCoreSchema_addSubject_java_lang_String_TestSynchronizedMetadataValidation_testNullArrayValue.sync.validateMetadataSynchronization(doc, metadata);

 ...
 */
public class TestProzeGen_Matrix_getValue_int_int_MatrixTest_testTranslation {
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        assertEquals(2, m.getValue(param0, param1), 0);
        assertEquals(4, m.getValue(param0, param1), 0);
        assertEquals(0, m.getValue(param0, param1), 0);
        assertEquals(4, m.getValue(param0, param1), 0);
        assertEquals(2, m.getValue(param0, param1), 0);
        assertEquals(0, m.getValue(param0, param1), 0);
        assertEquals(31, m.getValue(param0, param1), 0);
        assertEquals(44, m.getValue(param0, param1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_1(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        assertEquals(2, m.getValue(param0, param1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_2(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_3(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_4(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_5(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_6(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_7(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_8(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testTranslation_9(int param0, int param1) {
        Matrix m = new Matrix(2, 4, 4, 2, 15, 30);
        m.translate(2, 3);
        // assertEquals(2, m.getValue(0, 0), 0);
        // assertEquals(4, m.getValue(0, 1), 0);

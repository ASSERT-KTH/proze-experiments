...
public class TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testMaxEntries {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    // @Override
    @org.junit.jupiter.api.BeforeAll
    public static void setUp() throws Exception {
        TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testMaxEntries.OUT_DIR.mkdirs();
    }
    ...
    public void testMaxEntries(String param0) throws java.io.IOException {
        java.io.File file;
        String text;
        text = ("あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをん" + "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲン") + "１２３４５６７８";
        java.util.Set<Character> set = new java.util.HashSet<Character>(ToUnicodeWriter.MAX_ENTRIES_PER_OPERATOR);
        for (int i = 0; i < text.length(); ++i) {
            set.add(text.charAt(i));
        }
        assertEquals(ToUnicodeWriter.MAX_ENTRIES_PER_OPERATOR, set.size());
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
        org.apache.pdfbox.pdmodel.PDPage page = new org.apache.pdfbox.pdmodel.PDPage(org.apache.pdfbox.pdmodel.common.PDRectangle.A0);
        ...
        contentStream.close();
        file = new java.io.File(TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testMaxEntries.OUT_DIR, "PDFBOX-4302-test.pdf");
        document.save(file);
        document.close();
    ...
    private String getUnicodeText(java.io.File file) throws java.io.IOException {
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testMaxEntries_1(String param0) throws java.io.IOException {
        java.io.File file;
        String text;
        text = ("あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをん" + "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲン") + "１２３４５６７８";
        java.util.Set<Character> set = new java.util.HashSet<Character>(ToUnicodeWriter.MAX_ENTRIES_PER_OPERATOR);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testMaxEntries_2(String param0) throws java.io.IOException {
        java.io.File file;
        String text;
        text = ("あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをん" + "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲン") + "１２３４５６７８";
        java.util.Set<Character> set = new java.util.HashSet<Character>(ToUnicodeWriter.MAX_ENTRIES_PER_OPERATOR);
        ...
        // assertEquals(org.apache.pdfbox.pdmodel.font.ToUnicodeWriter.MAX_ENTRIES_PER_OPERATOR, set.size());
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
        org.apache.pdfbox.pdmodel.PDPage page = new org.apache.pdfbox.pdmodel.PDPage(org.apache.pdfbox.pdmodel.common.PDRectangle.A0);
        document.addPage(page);
        java.io.File ipafont = new java.io.File("target/fonts/ipag00303", "ipag.ttf");

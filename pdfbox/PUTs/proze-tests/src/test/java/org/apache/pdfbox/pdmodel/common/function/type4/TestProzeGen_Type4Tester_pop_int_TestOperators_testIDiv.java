...
public class TestProzeGen_Type4Tester_pop_int_TestOperators_testIDiv {
    /**
    ...
    public void testIDiv(int param0) throws Exception {
        Type4Tester.create("3 2 idiv").pop(param0).isEmpty();
        Type4Tester.create("4 2 idiv").pop(param0).isEmpty();
        Type4Tester.create("-5 2 idiv").pop(param0).isEmpty();
        try {

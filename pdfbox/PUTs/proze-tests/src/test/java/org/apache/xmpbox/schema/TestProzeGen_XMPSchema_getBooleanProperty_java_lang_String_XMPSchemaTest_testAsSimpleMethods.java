...
public class TestProzeGen_XMPSchema_getBooleanProperty_java_lang_String_XMPSchemaTest_testAsSimpleMethods {
    ...
    public void testAsSimpleMethods(String param0) throws Exception {
        ...
        assertEquals(Boolean.valueOf(boolVal), schem.getBooleanProperty(param0).getValue());

...
public class TestProzeGen_CMap_toUnicode_int_TestCMapParser_testLookup {
    /**
    ...
    public void testLookup(int param0) throws IOException {
        ...
        assertEquals( "A", cMap.toUnicode(param0),
                "bytes 00 01 from bfrange <0001> <0005> <0041>");
        byte[] bytes2 = new byte[]{ 1, 00 };
        String str2 = "0";
        assertEquals( str2, cMap.toUnicode(param0), "bytes 01 00 from bfrange <0100> <0109> <0030>");
        byte[] bytes3 = new byte[]{ 1, 32 };
        assertEquals("P", cMap.toUnicode(param0), "bytes 01 00 from bfrange <0100> <0109> <0030>");
        byte[] bytes4 = new byte[]{ 1, 33 };
        assertEquals( "R", cMap.toUnicode(param0), "bytes 01 00 from bfrange <0100> <0109> <0030>");
        byte[] bytes5 = new byte[]{ 0, 10 };
        String str5 = "*";
        assertEquals( str5, cMap.toUnicode(param0), "bytes 00 0A from bfchar <000A> <002A>");
        byte[] bytes6 = new byte[]{ 1, 10 };
        String str6 = "+";
        assertEquals( str6, cMap.toUnicode(param0), "bytes 01 0A from bfchar <010A> <002B>");
        int cid1 = 65;
    ...
    public void testLookup_1(int param0) throws IOException {
        CMap cMap = new CMapParser().parse(new java.io.File("src/test/resources/cmap", "CMapTest"));
        byte[] bytes1 = new byte[]{ 0, 1 };
        assertEquals( "A", cMap.toUnicode(param0), "bytes 00 01 from bfrange <0001> <0005> <0041>");
        byte[] bytes2 = new byte[]{ 1, 00 };
        String str2 = "0";

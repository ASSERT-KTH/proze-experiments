...
public class TestProzeGen_PDOptionalContentGroup_init_TestOptionalContentGroups_testOCGGenerationSameNameCanHaveSameVisibilityOff {
    private static final java.io.File testResultsDir = new java.io.File("target/test-output");

    @org.junit.jupiter.api.BeforeAll
    public static void setUp() throws Exception {
        // super.setUp();
        org.apache.pdfbox.pdmodel.graphics.optionalcontent.TestProzeGen_PDOptionalContentGroup_init_TestOptionalContentGroups_testOCGGenerationSameNameCanHaveSameVisibilityOff.testResultsDir.mkdirs();
    }
    ...
    public void testOCGGenerationSameNameCanHaveSameVisibilityOff(String param0) throws IOException {
        ...
        try {
            ...
            PDOptionalContentGroup disabled1 = new PDOptionalContentGroup(param0);
            ocprops.addGroup(disabled1);
            // Create OCG for disabled2 with same name as disabled1
            PDOptionalContentGroup disabled2 = new PDOptionalContentGroup(param0);
            ...
            java.io.File targetFile = new java.io.File(org.apache.pdfbox.pdmodel.graphics.optionalcontent.TestProzeGen_PDOptionalContentGroup_init_TestOptionalContentGroups_testOCGGenerationSameNameCanHaveSameVisibilityOff.testResultsDir, "ocg-generation-same-name-off.pdf");
            doc.save(targetFile.getAbsolutePath());
            doc.close();
            // render PDF with science disabled and alternatives with same name enabled
            doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(org.apache.pdfbox.pdmodel.graphics.optionalcontent.TestProzeGen_PDOptionalContentGroup_init_TestOptionalContentGroups_testOCGGenerationSameNameCanHaveSameVisibilityOff.testResultsDir, "ocg-generation-same-name-off.pdf"));
            ...
            javax.imageio.ImageIO.write(actualImage, "png", new java.io.File(org.apache.pdfbox.pdmodel.graphics.optionalcontent.TestProzeGen_PDOptionalContentGroup_init_TestOptionalContentGroups_testOCGGenerationSameNameCanHaveSameVisibilityOff.testResultsDir, "ocg-generation-same-name-off-actual.png"));
        } finally {
            doc.close();
        }
        ...
        try {
            ...
            javax.imageio.ImageIO.write(expectedImage, "png", new java.io.File(org.apache.pdfbox.pdmodel.graphics.optionalcontent.TestProzeGen_PDOptionalContentGroup_init_TestOptionalContentGroups_testOCGGenerationSameNameCanHaveSameVisibilityOff.testResultsDir, "ocg-generation-same-name-off-expected.png"));
        } finally {
            doc2.close();
        }

 ...
 */
public class TestProzeGen_GlyphTable_getGlyph_int_TTFSubsetterTest_testNonEmptySubset {
    /**
    ...
    public void testNonEmptySubset(int param0) throws java.io.IOException {
        ...
        assertNotNull(subset.getGlyph().getGlyph(param0));
        assertNull(subset.getGlyph().getGlyph(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_1(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_2(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_3(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_4(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_5(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_6(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_7(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testNonEmptySubset_8(int param0) throws java.io.IOException {
        TrueTypeFont full = new TTFParser().parse("src/test/resources/ttf/LiberationSans-Regular.ttf");
        TTFSubsetter ttfSubsetter = new TTFSubsetter(full);
        ttfSubsetter.add('a');
        java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();

 ...
 */
public class TestProzeGen_AdobePDFSchema_setProducer_java_lang_String_TestSynchronizedMetadataValidation_testBadSizeOfArrays {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_AdobePDFSchema_setProducer_java_lang_String_TestSynchronizedMetadataValidation_testBadSizeOfArrays.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testBadSizeOfArrays(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_AdobePDFSchema_setProducer_java_lang_String_TestSynchronizedMetadataValidation_testBadSizeOfArrays.sync.validateMetadataSynchronization(doc, metadata);

 ...
 */
public class TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testAllInfoSynchronized {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testAllInfoSynchronized.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testAllInfoSynchronized(String param0) throws Exception {
        initValues();
        ...
        try {
            ve = TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testAllInfoSynchronized.sync.validateMetadataSynchronization(doc, metadata);

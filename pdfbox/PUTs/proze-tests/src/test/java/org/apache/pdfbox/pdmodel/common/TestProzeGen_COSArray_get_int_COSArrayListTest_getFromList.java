...
public class TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList {
    ...
    public void setUp() throws Exception {
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList.add(txtMark);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList.add(txtLink);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList.add(aCircle);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList.size());
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(txtMark);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(txtLink);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(aCircle);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.size());
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray.add(txtMark);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray.add(txtLink);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray.add(aCircle);
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray.size());
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.pdPage.setAnnotations(TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList);
        // create test output directory
        TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.OUT_DIR.mkdirs();
    }
    ...
    public void getFromList(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsList, TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray);
        for (int i = 0; i < cosArrayList.size(); i++) {
            org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation annot = cosArrayList.get(i);
            assertEquals(TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.annotationsArray.get(param0), annot.getCOSObject(),
                    ((("PDAnnotations cosObject at " + i) + " shall be equal to index ") + i) + " of COSArray");
            // compare with Java List/Array
            assertEquals(TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.get(i), annot,
                    ((("PDAnnotations at " + i) + " shall be at index ") + i) + " of List");
            assertEquals(TestProzeGen_COSArray_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[i], annot.getCOSObject(),

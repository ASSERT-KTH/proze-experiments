...
public class TestProzeGen_CMap_toUnicode_int_TestCMap_testLookup {
    /**
     * Check whether the mapping is working correct.
     *
     * @throws IOException
     * 		If something went wrong during adding a mapping
     */
    ...
    public void testLookup(int param0) throws IOException {
        ...
        assertTrue("a".equals(cMap.toUnicode(param0)));
    }

...
public class TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    // @Override
    @org.junit.jupiter.api.BeforeAll
    public static void setUp() throws Exception {
        org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR.mkdirs();
    }
    ...
    public void testCIDFontType2VerticalSubsetProportional(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        ...
        org.apache.pdfbox.cos.COSArray metrics = ((org.apache.pdfbox.cos.COSArray) (w2.getObject(1)));
        int i = 0;
    ...
    private void validateCIDFontType2(boolean useSubset) throws Exception {
        ...
        stream.endText();
        stream.close();
        java.io.File file = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2.pdf");
        document.save(file);
        document.close();
    ...
    private class TrueTypeEmbedderTester extends TrueTypeEmbedder {
         ...
         */
        TrueTypeEmbedderTester(org.apache.pdfbox.pdmodel.PDDocument document, org.apache.pdfbox.cos.COSDictionary dict, org.apache.fontbox.ttf.TrueTypeFont ttf, boolean embedSubset) throws IOException {
            super(document, dict, ttf, embedSubset);
        }

        @Override
        protected void buildSubset(java.io.InputStream ttfSubset, String tag, java.util.Map<Integer, Integer> gidToCid) throws IOException {
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_1(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
...
//            assertEquals(n, metrics.getInt(i++));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_2(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
...
//            assertEquals(n, metrics.getInt(i++));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_3(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
...
//            assertEquals(n, metrics.getInt(i++));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_4(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
...
//            assertEquals(n, metrics.getInt(i++));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_5(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
...
//            assertEquals(n, metrics.getInt(i++));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_6(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCIDFontType2VerticalSubsetProportional_7(String param0) throws IOException {
        String text = "「ABC」";
        String expectedExtractedtext = "「\nA\nB\nC\n」";
        java.io.File pdf = new java.io.File(org.apache.pdfbox.pdmodel.font.TestProzeGen_PDPageContentStream_showText_java_lang_String_TestFontEmbedding_testCIDFontType2VerticalSubsetProportional.OUT_DIR, "CIDFontType2VP.pdf");
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();

...
public class TestProzeGen_PDAcroForm_getField_java_lang_String_HandleDifferentDALevelsTest_checkDifferentLayout {
    ...
    private static final java.lang.String NAME_OF_PDF = "DifferentDALevels.pdf";
    ...
    public void setUp() throws java.io.IOException {
        document = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_HandleDifferentDALevelsTest_checkDifferentLayout.IN_DIR, org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_HandleDifferentDALevelsTest_checkDifferentLayout.NAME_OF_PDF));
        acroForm = document.getDocumentCatalog().getAcroForm();
        org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_HandleDifferentDALevelsTest_checkDifferentLayout.OUT_DIR.mkdirs();
        // prefill the fields to generate the appearance streams
        org.apache.pdfbox.pdmodel.interactive.form.PDTextField field = ((org.apache.pdfbox.pdmodel.interactive.form.PDTextField) (acroForm.getField("SingleAnnotation")));
        field.setValue("single annotation");
        field = ((org.apache.pdfbox.pdmodel.interactive.form.PDTextField) (acroForm.getField("MultipeAnnotations-SameLayout")));
        field.setValue("same layout");
        field = ((org.apache.pdfbox.pdmodel.interactive.form.PDTextField) (acroForm.getField("MultipleAnnotations-DifferentLayout")));
        field.setValue("different layout");
        java.io.File file = new java.io.File(org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_HandleDifferentDALevelsTest_checkDifferentLayout.OUT_DIR, org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_HandleDifferentDALevelsTest_checkDifferentLayout.NAME_OF_PDF);
        document.save(file);
    }
    ...
    public void checkDifferentLayout(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDTextField field = ((org.apache.pdfbox.pdmodel.interactive.form.PDTextField) (acroForm.getField(param0)));
        java.lang.String fieldFontSetting = getFontSettingFromDA(field);
        java.util.List<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotationWidget> widgets = field.getWidgets();
        for (org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotationWidget widget : widgets) {
            java.lang.String widgetFontSetting = getFontSettingFromDA(widget);
            java.lang.String fontSetting = (widgetFontSetting == null) ? fieldFontSetting : widgetFontSetting;
            java.lang.String contentAsString = new java.lang.String(widget.getNormalAppearanceStream().getContentStream().toByteArray());
            assertTrue(contentAsString.indexOf(fontSetting) > 0,
                    "font setting in content stream shall be " + fontSetting);
        }
    }
    ...
    private java.lang.String getFontSettingFromDA(org.apache.pdfbox.pdmodel.interactive.form.PDTextField field) {
        java.lang.String defaultAppearance = field.getDefaultAppearance();
    ...
    private java.lang.String getFontSettingFromDA(org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotationWidget widget) {
        java.lang.String defaultAppearance = widget.getCOSObject().getString(org.apache.pdfbox.cos.COSName.DA);

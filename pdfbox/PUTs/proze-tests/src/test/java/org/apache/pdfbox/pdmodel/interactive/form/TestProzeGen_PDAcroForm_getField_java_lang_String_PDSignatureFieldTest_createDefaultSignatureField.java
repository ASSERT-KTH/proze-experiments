 ...
 */
public class TestProzeGen_PDAcroForm_getField_java_lang_String_PDSignatureFieldTest_createDefaultSignatureField {
    ...
    public void createDefaultSignatureField(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField sigField = new org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField(acroForm);
        ...
        java.util.List<org.apache.pdfbox.pdmodel.interactive.form.PDField> fields = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.form.PDField>();
        fields.add(sigField);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void createDefaultSignatureField_1(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField sigField = new org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField(acroForm);
        sigField.setPartialName("SignatureField");
        assertEquals(sigField.getFieldType(), sigField.getCOSObject().getNameAsString(org.apache.pdfbox.cos.COSName.FT));
        // assertEquals("Sig", sigField.getFieldType());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void createDefaultSignatureField_2(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField sigField = new org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField(acroForm);
        sigField.setPartialName("SignatureField");
        // assertEquals(sigField.getFieldType(), sigField.getCOSObject().getNameAsString(org.apache.pdfbox.cos.COSName.FT));
        assertEquals("Sig", sigField.getFieldType());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void createDefaultSignatureField_3(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField sigField = new org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField(acroForm);
        sigField.setPartialName("SignatureField");
        // assertEquals(sigField.getFieldType(), sigField.getCOSObject().getNameAsString(org.apache.pdfbox.cos.COSName.FT));
        // assertEquals("Sig", sigField.getFieldType());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void createDefaultSignatureField_4(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField sigField = new org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField(acroForm);
        sigField.setPartialName("SignatureField");
        // assertEquals(sigField.getFieldType(), sigField.getCOSObject().getNameAsString(org.apache.pdfbox.cos.COSName.FT));
        // assertEquals("Sig", sigField.getFieldType());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void createDefaultSignatureField_5(java.lang.String param0) throws java.io.IOException {
        org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField sigField = new org.apache.pdfbox.pdmodel.interactive.form.PDSignatureField(acroForm);
        sigField.setPartialName("SignatureField");
        // assertEquals(sigField.getFieldType(), sigField.getCOSObject().getNameAsString(org.apache.pdfbox.cos.COSName.FT));
        // assertEquals("Sig", sigField.getFieldType());

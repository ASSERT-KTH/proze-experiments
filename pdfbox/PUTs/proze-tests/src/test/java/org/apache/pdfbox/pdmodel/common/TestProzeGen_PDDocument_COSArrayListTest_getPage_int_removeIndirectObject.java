...
public class TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject {
    ...
    public static void setUp() throws Exception {
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList.add(txtMark);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList.add(txtLink);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList.add(aCircle);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList.size());
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsList.size());
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsArray.add(txtMark);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsArray.add(txtLink);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsArray.add(aCircle);
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsArray.size());
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.pdPage.setAnnotations(TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.annotationsList);
        // create test output directory
        TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeIndirectObject(int param0) throws java.io.IOException {
        ...
        pdf.save(TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.OUT_DIR + "/removeIndirectObjectTest.pdf");
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDDocument_COSArrayListTest_getPage_int_removeIndirectObject.OUT_DIR + "/removeIndirectObjectTest.pdf"));

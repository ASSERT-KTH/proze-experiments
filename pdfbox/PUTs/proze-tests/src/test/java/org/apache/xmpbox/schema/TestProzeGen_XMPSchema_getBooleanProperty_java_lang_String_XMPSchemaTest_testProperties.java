...
public class TestProzeGen_XMPSchema_getBooleanProperty_java_lang_String_XMPSchemaTest_testProperties {
    ...
    public void testProperties(String param0) throws Exception {
        ...
        assertEquals(boolType, schem.getBooleanProperty(param0));
        ...
        ok = false;
        try {
            schem.getBooleanProperty(param0);
        } catch (IllegalArgumentException e) {
            ok = true;
        }
    }

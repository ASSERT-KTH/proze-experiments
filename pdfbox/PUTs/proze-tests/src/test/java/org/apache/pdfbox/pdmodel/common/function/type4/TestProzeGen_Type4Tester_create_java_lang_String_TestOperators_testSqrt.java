...
public class TestProzeGen_Type4Tester_create_java_lang_String_TestOperators_testSqrt {
    /**
    ...
    public void testSqrt(String param0) throws Exception {
        Type4Tester.create(param0).popReal(0.0F).isEmpty();
        Type4Tester.create(param0).popReal(1.0F).isEmpty();
        Type4Tester.create(param0).popReal(2.0F).isEmpty();
        Type4Tester.create(param0).popReal(2.097617F, 1.0E-6).isEmpty();
        try {

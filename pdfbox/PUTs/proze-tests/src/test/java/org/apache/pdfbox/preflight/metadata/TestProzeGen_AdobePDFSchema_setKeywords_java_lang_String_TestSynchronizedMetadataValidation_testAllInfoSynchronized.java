 ...
 */
public class TestProzeGen_AdobePDFSchema_setKeywords_java_lang_String_TestSynchronizedMetadataValidation_testAllInfoSynchronized {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_AdobePDFSchema_setKeywords_java_lang_String_TestSynchronizedMetadataValidation_testAllInfoSynchronized.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testAllInfoSynchronized(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_AdobePDFSchema_setKeywords_java_lang_String_TestSynchronizedMetadataValidation_testAllInfoSynchronized.sync.validateMetadataSynchronization(doc, metadata);

...
public class TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940 {
    ...
    private int getNumberOfTempFile() {
        int result = 0;
        java.io.File[] tmpPdfs = TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.tmpDirectory.listFiles(new java.io.FilenameFilter() {
            @Override
    ...
    public void testPDFBox3940(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_1(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        assertEquals("Unknown", di.getAuthor());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());
        ...
        // assertEquals("", di.getSubject());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.PDF", di.getTitle());
        // assertEquals(org.apache.pdfbox.util.DateConverter.toCalendar("Tuesday, July 28, 1998 4:00:09 PM"), di.getCreationDate());
        doc.close();
    }
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_2(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        // assertEquals("Unknown", di.getAuthor());
        assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_3(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        // assertEquals("Unknown", di.getAuthor());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_4(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        // assertEquals("Unknown", di.getAuthor());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_5(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        // assertEquals("Unknown", di.getAuthor());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_6(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        // assertEquals("Unknown", di.getAuthor());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFBox3940_7(String param0) throws IOException {
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_DateConverter_toCalendar_java_lang_String_TestPDFParser_testPDFBox3940.TARGETPDFDIR, "PDFBOX-3940-079977.pdf"));
        org.apache.pdfbox.pdmodel.PDDocumentInformation di = doc.getDocumentInformation();
        // assertEquals("Unknown", di.getAuthor());
        // assertEquals("C:REGULA~1IREGSFR_EQ_EM.WP", di.getCreator());

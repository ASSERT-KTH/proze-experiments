 ...
 */
public class TestProzeGen_PDDocument_getPage_int_TestPDPageTree_positiveMultipleLevel {
    ...
    public void positiveMultipleLevel(int param0) throws java.io.IOException {
        doc = PDDocument.load(TestProzeGen_PDDocument_getPage_int_TestPDPageTree_positiveMultipleLevel.class.getResourceAsStream("page_tree_multiple_levels.pdf"));

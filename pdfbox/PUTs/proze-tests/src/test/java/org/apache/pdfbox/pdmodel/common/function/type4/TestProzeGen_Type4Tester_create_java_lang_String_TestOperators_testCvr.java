...
public class TestProzeGen_Type4Tester_create_java_lang_String_TestOperators_testCvr {
    /**
    ...
    public void testCvr(String param0) throws Exception {
        Type4Tester.create(param0).popReal(-47.8F).isEmpty();
        Type4Tester.create(param0).popReal(520.9F).isEmpty();
        Type4Tester.create(param0).popReal(77.0F).isEmpty();
        ExecutionContext context = Type4Tester.create(param0).toExecutionContext();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCvr_1(String param0) throws Exception {
        Type4Tester.create(param0).popReal(-47.8F).isEmpty();
        Type4Tester.create(param0).popReal(520.9F).isEmpty();
        Type4Tester.create(param0).popReal(77.0F).isEmpty();
        ExecutionContext context = Type4Tester.create(param0).toExecutionContext();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCvr_2(String param0) throws Exception {
        Type4Tester.create(param0).popReal(-47.8F).isEmpty();
        Type4Tester.create(param0).popReal(520.9F).isEmpty();
        Type4Tester.create(param0).popReal(77.0F).isEmpty();
        ExecutionContext context = Type4Tester.create(param0).toExecutionContext();

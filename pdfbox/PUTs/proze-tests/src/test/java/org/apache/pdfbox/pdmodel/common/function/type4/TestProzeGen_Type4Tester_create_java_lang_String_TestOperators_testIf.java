...
public class TestProzeGen_Type4Tester_create_java_lang_String_TestOperators_testIf {
    /**
    ...
    public void testIf(String param0) throws Exception {
        Type4Tester.create(param0).pop(3).isEmpty();
        Type4Tester.create(param0).isEmpty();
        try {

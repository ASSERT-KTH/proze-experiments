...
public class TestProzeGen_CMap_toUnicode_int_TestCMapParser_testParserWithMalformedbfrange1 {
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testParserWithMalformedbfrange1(int param0) throws java.io.IOException {
        CMap cMap = new CMapParser().parse(new java.io.File("src/test/resources/cmap", "CMapMalformedbfrange1"));
        assertNotNull(cMap, "Failed to parse malformed CMap file");
        byte[] bytes1 = new byte[]{ 0, 1 };
        assertEquals("A", cMap.toUnicode(param0), "bytes 00 01 from bfrange <0001> <0009> <0041>");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testParserWithMalformedbfrange1_1(int param0) throws java.io.IOException {
        CMap cMap = new CMapParser().parse(new java.io.File("src/test/resources/cmap", "CMapMalformedbfrange1"));
        assertNotNull(cMap, "Failed to parse malformed CMap file");
        byte[] bytes1 = new byte[]{ 0, 1 };
        // assertEquals("bytes 00 01 from bfrange <0001> <0009> <0041>", "A", cMap.toUnicode(org.apache.fontbox.cmap.CMap.toInt(bytes1, bytes1.length)));
        byte[] bytes2 = new byte[]{ 1, 00 };
        // assertNull(cMap.toUnicode(org.apache.fontbox.cmap.CMap.toInt(bytes2, bytes2.length)));
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testParserWithMalformedbfrange1_2(int param0) throws java.io.IOException {
        CMap cMap = new CMapParser().parse(new java.io.File("src/test/resources/cmap", "CMapMalformedbfrange1"));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testParserWithMalformedbfrange1_3(int param0) throws java.io.IOException {
        CMap cMap = new CMapParser().parse(new java.io.File("src/test/resources/cmap", "CMapMalformedbfrange1"));
        // assertNotNull("Failed to parse malformed CMap file", cMap);
        byte[] bytes1 = new byte[]{ 0, 1 };
        // assertEquals("bytes 00 01 from bfrange <0001> <0009> <0041>", "A", cMap.toUnicode(org.apache.fontbox.cmap.CMap.toInt(bytes1, bytes1.length)));

...
public class TestProzeGen_XMPSchema_getUnqualifiedBagValueList_java_lang_String_XMPSchemaTest_testMergeSchema {
    ...
    public void testMergeSchema(String param0) throws Exception {
        ...
        java.util.List<String> bag = schem1.getUnqualifiedBagValueList(param0);

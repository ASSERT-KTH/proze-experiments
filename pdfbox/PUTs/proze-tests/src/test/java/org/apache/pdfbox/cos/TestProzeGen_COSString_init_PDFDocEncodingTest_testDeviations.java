 ...
 */
public class TestProzeGen_COSString_init_PDFDocEncodingTest_testDeviations {
    ...
    public void testDeviations(String param0) {
        for (String deviation : TestProzeGen_COSString_init_PDFDocEncodingTest_testDeviations.deviations) {
            COSString cosString = new COSString(param0);

...
public class TestProzeGen_XMPSchema_getUnqualifiedTextPropertyValue_java_lang_String_XMPSchemaTest_testSetSpecifiedSimpleTypeProperty {
    ...
    public void testSetSpecifiedSimpleTypeProperty(String param0) throws Exception {
        ...
        assertEquals(val, schem.getUnqualifiedTextPropertyValue(param0));
        schem.setTextPropertyValueAsSimple(prop, val2);
        assertEquals(val2, schem.getUnqualifiedTextPropertyValue(param0));

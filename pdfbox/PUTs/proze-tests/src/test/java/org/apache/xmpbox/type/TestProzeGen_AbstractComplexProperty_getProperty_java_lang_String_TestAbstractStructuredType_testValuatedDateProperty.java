...
public class TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty {
    ...
    public void before() throws Exception {
        ...
        st = new MyStructuredType(xmp, TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MY_NS, TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MY_PREFIX);
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedDateProperty(String param0) throws Exception {
        ...
        assertNotNull(st.getProperty(param0));
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedDateProperty_1(String param0) throws Exception {
        java.util.Calendar c = java.util.Calendar.getInstance();
        st.addSimpleProperty(MyStructuredType.MYDATE, c);
        assertEquals(c, st.getDatePropertyAsCalendar(MyStructuredType.MYDATE));
        // assertNull(st.getDatePropertyAsCalendar(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MyStructuredType.MYTEXT));
        // assertNotNull(st.getProperty(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MyStructuredType.MYDATE));
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedDateProperty_2(String param0) throws Exception {
        java.util.Calendar c = java.util.Calendar.getInstance();
        st.addSimpleProperty(MyStructuredType.MYDATE, c);
        // assertEquals(c, st.getDatePropertyAsCalendar(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MyStructuredType.MYDATE));
        assertNull(st.getDatePropertyAsCalendar(MyStructuredType.MYTEXT));
        // assertNotNull(st.getProperty(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MyStructuredType.MYDATE));
    }
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedDateProperty_3(String param0) throws Exception {
        java.util.Calendar c = java.util.Calendar.getInstance();
        st.addSimpleProperty(MyStructuredType.MYDATE, c);
        // assertEquals(c, st.getDatePropertyAsCalendar(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MyStructuredType.MYDATE));
        // assertNull(st.getDatePropertyAsCalendar(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedDateProperty.MyStructuredType.MYTEXT));

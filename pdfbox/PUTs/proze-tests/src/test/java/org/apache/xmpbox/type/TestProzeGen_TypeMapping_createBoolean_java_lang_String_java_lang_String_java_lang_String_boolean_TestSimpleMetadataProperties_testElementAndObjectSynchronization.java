 ...
 * @author a183132
 */
public class TestProzeGen_TypeMapping_createBoolean_java_lang_String_java_lang_String_java_lang_String_boolean_TestSimpleMetadataProperties_testElementAndObjectSynchronization {
    ...
    public void testElementAndObjectSynchronization(String param0, String param1, String param2, boolean param3) throws Exception {
        boolean boolv = true;
        java.util.Calendar datev = java.util.Calendar.getInstance();
        int integerv = 1;
        float realv = Float.parseFloat("1.69");
        String textv = "TEXTCONTENT";
        BooleanType bool = parent.getTypeMapping().createBoolean(param0, param1, param2, param3);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testElementAndObjectSynchronization_1(String param0, String param1, String param2, boolean param3) throws Exception {
        boolean boolv = true;
        java.util.Calendar datev = java.util.Calendar.getInstance();
        int integerv = 1;
        float realv = Float.parseFloat("1.69");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testElementAndObjectSynchronization_2(String param0, String param1, String param2, boolean param3) throws Exception {
        boolean boolv = true;
        java.util.Calendar datev = java.util.Calendar.getInstance();
        int integerv = 1;
        float realv = Float.parseFloat("1.69");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testElementAndObjectSynchronization_3(String param0, String param1, String param2, boolean param3) throws Exception {
        boolean boolv = true;
        java.util.Calendar datev = java.util.Calendar.getInstance();
        int integerv = 1;
        float realv = Float.parseFloat("1.69");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testElementAndObjectSynchronization_4(String param0, String param1, String param2, boolean param3) throws Exception {
        boolean boolv = true;
        java.util.Calendar datev = java.util.Calendar.getInstance();
        int integerv = 1;
        float realv = Float.parseFloat("1.69");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testElementAndObjectSynchronization_5(String param0, String param1, String param2, boolean param3) throws Exception {
        boolean boolv = true;
        java.util.Calendar datev = java.util.Calendar.getInstance();
        int integerv = 1;
        float realv = Float.parseFloat("1.69");

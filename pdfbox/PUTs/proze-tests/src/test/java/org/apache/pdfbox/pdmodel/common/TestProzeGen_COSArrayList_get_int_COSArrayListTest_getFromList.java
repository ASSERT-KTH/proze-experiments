...
public class TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList {
    ...
    public void setUp() throws Exception {
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.pdPage.setAnnotations(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList);
        // create test output directory
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.OUT_DIR.mkdirs();
    }
    ...
    public void getFromList(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray);
        for (int i = 0; i < cosArrayList.size(); i++) {
            ...
            assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.get(i), annot.getCOSObject(),
                    ((("PDAnnotations cosObject at " + i) + " shall be equal to index ") + i) + " of COSArray");
            // compare with Java List/Array
            assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsList.get(i), annot,
                    ((("PDAnnotations at " + i) + " shall be at index ") + i) + " of List");
            assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.tbcAnnotationsArray[i], annot.getCOSObject(),
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void getFromList_1(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray);
        for (int i = 0; i < cosArrayList.size(); i++) {
            org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation annot = cosArrayList.get(param0);
            assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.get(i), annot.getCOSObject(),
...
//                    ((("PDAnnotations cosObject at " + i) + " shall be at position ") + i) + " of Array");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void getFromList_2(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray);
        for (int i = 0; i < cosArrayList.size(); i++) {
            org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation annot = cosArrayList.get(param0);
//            assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.get(i), annot.getCOSObject(),
...
//                    ((("PDAnnotations cosObject at " + i) + " shall be at position ") + i) + " of Array");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void getFromList_3(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsList, TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray);
        for (int i = 0; i < cosArrayList.size(); i++) {
            org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation annot = cosArrayList.get(param0);
//            assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_getFromList.annotationsArray.get(i), annot.getCOSObject(),

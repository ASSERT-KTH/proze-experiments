...
public class TestProzeGen_PDDocument_save_java_lang_String_CCITTFactoryTest_testCreateFromBufferedImage {
    ...
    public static void setUp() throws Exception {
        // super.setUp();
        TestProzeGen_PDDocument_save_java_lang_String_CCITTFactoryTest_testCreateFromBufferedImage.testResultsDir.mkdirs();
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCreateFromBufferedImage(String param0) throws java.io.IOException {
        String tiffG4Path = "src/test/resources/org/apache/pdfbox/pdmodel/graphics/image/ccittg4.tif";
        org.apache.pdfbox.pdmodel.PDDocument document = new org.apache.pdfbox.pdmodel.PDDocument();
        java.awt.image.BufferedImage bim = javax.imageio.ImageIO.read(new java.io.File(tiffG4Path));
        ...
        document.close();
        document = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDDocument_save_java_lang_String_CCITTFactoryTest_testCreateFromBufferedImage.testResultsDir, "singletifffrombi.pdf"));

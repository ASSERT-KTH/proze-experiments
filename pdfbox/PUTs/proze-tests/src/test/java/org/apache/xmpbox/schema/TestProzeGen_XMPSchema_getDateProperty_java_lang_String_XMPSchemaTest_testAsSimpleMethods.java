...
public class TestProzeGen_XMPSchema_getDateProperty_java_lang_String_XMPSchemaTest_testAsSimpleMethods {
    ...
    public void testAsSimpleMethods(String param0) throws Exception {
        ...
        assertEquals(dateVal, schem.getDateProperty(param0).getValue());

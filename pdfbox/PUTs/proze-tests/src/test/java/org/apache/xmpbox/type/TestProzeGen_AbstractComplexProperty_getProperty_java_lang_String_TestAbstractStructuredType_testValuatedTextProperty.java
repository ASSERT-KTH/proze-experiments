...
public class TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty {
    ...
    public void before() throws Exception {
        ...
        st = new MyStructuredType(xmp, TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MY_NS, TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MY_PREFIX);
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedTextProperty(String param0) throws Exception {
        String s = "my value";
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedTextProperty_1(String param0) throws Exception {
        String s = "my value";
        st.addSimpleProperty(MyStructuredType.MYTEXT, s);
        assertEquals(s, st.getPropertyValueAsString(MyStructuredType.MYTEXT));
        // assertNull(st.getPropertyValueAsString(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MyStructuredType.MYDATE));
        // assertNotNull(st.getProperty(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MyStructuredType.MYTEXT));
    }

    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedTextProperty_2(String param0) throws Exception {
        String s = "my value";
        st.addSimpleProperty(MyStructuredType.MYTEXT, s);
        // assertEquals(s, st.getPropertyValueAsString(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MyStructuredType.MYTEXT));
        assertNull(st.getPropertyValueAsString(MyStructuredType.MYDATE));
        // assertNotNull(st.getProperty(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MyStructuredType.MYTEXT));
    }
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testValuatedTextProperty_3(String param0) throws Exception {
        String s = "my value";
        st.addSimpleProperty(MyStructuredType.MYTEXT, s);
        // assertEquals(s, st.getPropertyValueAsString(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MyStructuredType.MYTEXT));
        // assertNull(st.getPropertyValueAsString(org.apache.xmpbox.type.TestProzeGen_AbstractComplexProperty_getProperty_java_lang_String_TestAbstractStructuredType_testValuatedTextProperty.MyStructuredType.MYDATE));

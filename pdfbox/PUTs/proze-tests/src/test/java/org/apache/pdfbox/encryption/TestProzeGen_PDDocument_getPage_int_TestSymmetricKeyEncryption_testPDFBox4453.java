...
public class TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453 {
    /**
     * Logger instance.
     */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.class);
    ...
    public static void setUp() throws Exception {
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.testResultsDir.mkdirs();
        ...
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission = new org.apache.pdfbox.pdmodel.encryption.AccessPermission();
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanAssembleDocument(false);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanExtractContent(false);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanExtractForAccessibility(true);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanFillInForm(false);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanModify(false);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanModifyAnnotations(false);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanPrint(true);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setCanPrintDegraded(false);
        org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.permission.setReadOnly();
    }
    ...
    public void testPDFBox4453(int param0) throws IOException {
        ...
        java.io.File file = new java.io.File(org.apache.pdfbox.encryption.TestProzeGen_PDDocument_getPage_int_TestSymmetricKeyEncryption_testPDFBox4453.testResultsDir, "PDFBOX-4453.pdf");
        ...
        for (int i = 0; i < TESTCOUNT; ++i) {
            ...
            doc.getPage(param0).getCOSObject().setItem(org.apache.pdfbox.cos.COSName.getPDFName("_Test-" + i), dict);
        ...
        for (int i = 0; i < TESTCOUNT; ++i) {
            org.apache.pdfbox.cos.COSDictionary dict = doc.getPage(param0).getCOSObject().getCOSDictionary(org.apache.pdfbox.cos.COSName.getPDFName("_Test-" + i));

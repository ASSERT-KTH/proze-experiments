...
public class TestProzeGen_XMPSchema_getUnqualifiedLanguagePropertyValue_java_lang_String_java_lang_String_XMPSchemaTest_testMergeSchema {
    ...
    public void testMergeSchema(String param0, String param1) throws Exception {
        ...
        schem1.merge(schem2);
        assertEquals(valAltSchem2, schem1.getUnqualifiedLanguagePropertyValue(param0, param1));
        assertEquals(valAltSchem1, schem1.getUnqualifiedLanguagePropertyValue(param0, param1));

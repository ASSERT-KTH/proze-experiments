...
public class TestProzeGen_COSName_getPDFName_java_lang_String_TestCOSName_PDFBox4076 {
    /**
    ...
    public void PDFBox4076(String param0) throws IOException {
        ...
        document.getDocumentCatalog().getCOSObject().setString(COSName.getPDFName(param0), special);

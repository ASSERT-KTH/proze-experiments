 ...
 */
public class TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testBadSizeOfArrays {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testBadSizeOfArrays.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testBadSizeOfArrays(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testBadSizeOfArrays.sync.validateMetadataSynchronization(doc, metadata);

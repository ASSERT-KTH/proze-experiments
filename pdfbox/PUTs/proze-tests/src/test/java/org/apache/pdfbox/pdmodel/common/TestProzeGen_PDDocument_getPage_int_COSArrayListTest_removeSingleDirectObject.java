...
public class TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject {
    ...
    public void setUp() throws Exception {
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(txtMark);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(txtLink);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(aCircle);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList.size());
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsList.size());
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(txtMark);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(txtLink);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(aCircle);
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsArray.size());
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.pdPage.setAnnotations(TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.annotationsList);
        // create test output directory
        TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeSingleDirectObject(int param0) throws java.io.IOException {
        ...
        pdf.save(TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.OUT_DIR + "/removeSingleDirectObjectTest.pdf");
        pdf.close();
        pdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDDocument_getPage_int_COSArrayListTest_removeSingleDirectObject.OUT_DIR + "/removeSingleDirectObjectTest.pdf"));

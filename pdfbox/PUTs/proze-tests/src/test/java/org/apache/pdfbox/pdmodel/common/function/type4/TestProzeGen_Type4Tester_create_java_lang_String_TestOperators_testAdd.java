...
public class TestProzeGen_Type4Tester_create_java_lang_String_TestOperators_testAdd {
    /**
    ...
    public void testAdd(String param0) throws Exception {
        Type4Tester.create(param0).pop(11).isEmpty();
        Type4Tester.create(param0).pop(5.23F).isEmpty();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAdd_1(String param0) throws Exception {
        Type4Tester.create(param0).pop(11).isEmpty();
        Type4Tester.create(param0).pop(5.23F).isEmpty();
        int bigValue = Integer.MAX_VALUE - 2;
        ExecutionContext context = Type4Tester.create(param0).toExecutionContext();
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAdd_2(String param0) throws Exception {
        Type4Tester.create(param0).pop(11).isEmpty();
        Type4Tester.create(param0).pop(5.23F).isEmpty();
        int bigValue = Integer.MAX_VALUE - 2;
        ExecutionContext context = Type4Tester.create(param0).toExecutionContext();

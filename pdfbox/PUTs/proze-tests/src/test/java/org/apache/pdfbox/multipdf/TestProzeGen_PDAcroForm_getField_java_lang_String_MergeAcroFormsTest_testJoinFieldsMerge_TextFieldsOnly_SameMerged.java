 ...
 */
public class TestProzeGen_PDAcroForm_getField_java_lang_String_MergeAcroFormsTest_testJoinFieldsMerge_TextFieldsOnly_SameMerged {
    ...
    public void setUp() {
        TestProzeGen_PDAcroForm_getField_java_lang_String_MergeAcroFormsTest_testJoinFieldsMerge_TextFieldsOnly_SameMerged.OUT_DIR.mkdirs();
    }
    ...
    public void testJoinFieldsMerge_TextFieldsOnly_SameMerged(String param0) throws java.io.IOException {
        ...
        java.io.File toBeMerged = new java.io.File(TestProzeGen_PDAcroForm_getField_java_lang_String_MergeAcroFormsTest_testJoinFieldsMerge_TextFieldsOnly_SameMerged.IN_DIR, "AcroFormForMerge-TextFieldsOnly.pdf");
        java.io.File pdfOutput = new java.io.File(TestProzeGen_PDAcroForm_getField_java_lang_String_MergeAcroFormsTest_testJoinFieldsMerge_TextFieldsOnly_SameMerged.OUT_DIR, "PDFBoxJoinFieldsMerge-TextFieldsOnly-SameMerged.pdf");
        ...
        try {
            compliantDocument = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDAcroForm_getField_java_lang_String_MergeAcroFormsTest_testJoinFieldsMerge_TextFieldsOnly_SameMerged.IN_DIR, "AcrobatMerge-TextFieldsOnly-SameMerged.pdf"));
            toBeCompared = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDAcroForm_getField_java_lang_String_MergeAcroFormsTest_testJoinFieldsMerge_TextFieldsOnly_SameMerged.OUT_DIR, "PDFBoxJoinFieldsMerge-TextFieldsOnly-SameMerged.pdf"));

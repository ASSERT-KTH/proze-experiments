 ...
 */
public class TestProzeGen_PDTextField_setValue_java_lang_String_TestCreateSimpleForms_testCreateSimpleForm {
    public TestProzeGen_PDTextField_setValue_java_lang_String_TestCreateSimpleForms_testCreateSimpleForm() {
    }
    ...
    public void testCreateSimpleForm(String param0) throws java.io.IOException {
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCreateSimpleForm_1(String param0) throws java.io.IOException {
        CreateSimpleForm.main(null);
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File("target/SimpleForm.pdf"));
        new org.apache.pdfbox.rendering.PDFRenderer(doc).renderImage(0);
        org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroForm = doc.getDocumentCatalog().getAcroForm();
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCreateSimpleForm_2(String param0) throws java.io.IOException {
        CreateSimpleForm.main(null);
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File("target/SimpleForm.pdf"));
        new org.apache.pdfbox.rendering.PDFRenderer(doc).renderImage(0);
        org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroForm = doc.getDocumentCatalog().getAcroForm();
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCreateSimpleForm_3(String param0) throws java.io.IOException {
        CreateSimpleForm.main(null);
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File("target/SimpleForm.pdf"));
        new org.apache.pdfbox.rendering.PDFRenderer(doc).renderImage(0);
        org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroForm = doc.getDocumentCatalog().getAcroForm();
...
//            assertTrue(ex.getMessage().contains("U+0141 ('Lslash') is not available"));
    ...
    @NullSource
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testCreateSimpleForm_4(String param0) throws java.io.IOException {
        CreateSimpleForm.main(null);
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File("target/SimpleForm.pdf"));
        new org.apache.pdfbox.rendering.PDFRenderer(doc).renderImage(0);
        org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroForm = doc.getDocumentCatalog().getAcroForm();

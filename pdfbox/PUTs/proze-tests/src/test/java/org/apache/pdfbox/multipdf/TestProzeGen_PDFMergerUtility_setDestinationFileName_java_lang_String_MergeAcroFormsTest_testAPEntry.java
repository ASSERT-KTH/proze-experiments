 ...
 */
public class TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAPEntry {
    ...
    public void setUp() {
        TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAPEntry.OUT_DIR.mkdirs();
    }
    ...
    public void testAPEntry(String param0) throws java.io.IOException {
        ...
        try {
            java.io.File file1 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAPEntry.TARGET_PDF_DIR, "PDFBOX-1100-1.pdf");
            is1 = new java.io.FileInputStream(file1);
            java.io.File file2 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAPEntry.TARGET_PDF_DIR, "PDFBOX-1100-2.pdf");
            is2 = new java.io.FileInputStream(file2);
            java.io.File pdfOutput = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAPEntry.OUT_DIR, "PDFBOX-1100.pdf");

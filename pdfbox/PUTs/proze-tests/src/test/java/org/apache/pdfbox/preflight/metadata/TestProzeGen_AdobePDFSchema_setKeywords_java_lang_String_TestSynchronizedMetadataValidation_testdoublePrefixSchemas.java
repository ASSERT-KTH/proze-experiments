 ...
 */
public class TestProzeGen_AdobePDFSchema_setKeywords_java_lang_String_TestSynchronizedMetadataValidation_testdoublePrefixSchemas {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_AdobePDFSchema_setKeywords_java_lang_String_TestSynchronizedMetadataValidation_testdoublePrefixSchemas.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testdoublePrefixSchemas(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_AdobePDFSchema_setKeywords_java_lang_String_TestSynchronizedMetadataValidation_testdoublePrefixSchemas.sync.validateMetadataSynchronization(doc, metadata);

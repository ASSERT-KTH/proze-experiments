...
public class TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems {
    /**
     * Logger instance.
     */
    private static final org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.class);
    ...
    public void setUp() throws Exception {
        ...
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper = new PDFTextStripper();
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setLineSeparator("\n");
    }
        ...
        if ((expected == null) && (actual == null)) {
            ...
            while ((expectedIndex < expectedArray.length) && (actualIndex < actualArray.length)) {
                if (expectedArray[expectedIndex] != actualArray[actualIndex]) {
                    equals = false;
                    TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.warn(((((((("Lines differ at index" + " expected:") + expectedIndex) + "-") + ((int) (expectedArray[expectedIndex]))) + " actual:") + actualIndex) + "-") + ((int) (actualArray[actualIndex])));
                    break;
                }
            ...
            if (equals) {
                if (expectedIndex != expectedArray.length) {
                    equals = false;
                    TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.warn("Expected line is longer at:" + expectedIndex);
                }
                if (actualIndex != actualArray.length) {
                    equals = false;
                    TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.warn("Actual line is longer at:" + actualIndex);
                }
                if (expectedArray.length != actualArray.length) {
                    equals = false;
                    TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.warn((("Expected lines: " + expectedArray.length) + ", actual lines: ") + actualArray.length);
                }
            }
        } else {
     ...
     * @param bSort
     * 		Whether or not the extracted text is sorted
     * @throws Exception
     * 		when there is an exception
     */
    public void doTestFile(java.io.File inFile, java.io.File outDir, boolean bLogResult, boolean bSort) throws Exception {
        if (bSort) {
            TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.info(("Preparing to parse " + inFile.getName()) + " for sorted test");
        } else {
            TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.info(("Preparing to parse " + inFile.getName()) + " for standard test");
        }
        if (!outDir.exists()) {
            if (!outDir.mkdirs()) {
        ...
        org.apache.pdfbox.pdmodel.PDDocument document = org.apache.pdfbox.pdmodel.PDDocument.load(inFile);
        try {
            java.io.File outFile;
            java.io.File diffFile;
            java.io.File expectedFile;
            if (bSort) {
                outFile = new java.io.File(outDir, inFile.getName() + "-sorted.txt");
                diffFile = new java.io.File(outDir, inFile.getName() + "-sorted-diff.txt");
                expectedFile = new java.io.File(inFile.getParentFile(), inFile.getName() + "-sorted.txt");
            } else {
                outFile = new java.io.File(outDir, inFile.getName() + ".txt");
                diffFile = new java.io.File(outDir, inFile.getName() + "-diff.txt");
                expectedFile = new java.io.File(inFile.getParentFile(), inFile.getName() + ".txt");
            }
            ...
            try {
                ...
                os.write(0xbb);
                os.write(0xbf);
                java.io.Writer writer = new java.io.BufferedWriter(new java.io.OutputStreamWriter(os, TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.ENCODING));
                try {
                    // Allows for sorted tests
                    TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setSortByPosition(bSort);
                    TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.writeText(document, writer);
                } finally {
            ...
            if (bLogResult) {
                TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.info(("Text for " + inFile.getName()) + ":");
                TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.info(TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(document));
            }
            if (!expectedFile.exists()) {
                this.bFail = true;
                TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.error(("FAILURE: Input verification file: " + expectedFile.getAbsolutePath()) + " did not exist");
                return;
            }
    ...
    private void compareResult(java.io.File expectedFile, java.io.File outFile, java.io.File inFile, boolean bSort, java.io.File diffFile) throws IOException {
        ...
        java.io.LineNumberReader expectedReader = new java.io.LineNumberReader(new java.io.InputStreamReader(new java.io.FileInputStream(expectedFile), TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.ENCODING));
        java.io.LineNumberReader actualReader = new java.io.LineNumberReader(new java.io.InputStreamReader(new java.io.FileInputStream(outFile), TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.ENCODING));
        while (true) {
            ...
            if (!stringsEqual(expectedLine, actualLine)) {
                this.bFail = true;
                localFail = true;
                TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.log.error((((((((((((((("FAILURE: Line mismatch for file " + inFile.getName()) + " (sort = ") + bSort) + ")") + " at expected line: ") + expectedReader.getLineNumber()) + " at actual line: ") + actualReader.getLineNumber()) + "\nexpected line was: \"") + expectedLine) + "\"") + "\nactual line was:   \"") + actualLine) + "\"") + "\n");
        ...
        if (!localFail) {
            ...
            java.util.List<String> original = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.fileToLines(expectedFile);
            java.util.List<String> revised = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.fileToLines(outFile);
            // Compute diff. Get the Patch object. Patch is the container for computed deltas.
            difflib.Patch patch = difflib.DiffUtils.diff(original, revised);
            java.io.PrintStream diffPS = new java.io.PrintStream(diffFile, TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.ENCODING);
            for (Object delta : patch.getDeltas()) {
                if (delta instanceof difflib.ChangeDelta) {
                    difflib.ChangeDelta<String> cdelta = ((difflib.ChangeDelta<String>) (delta));
                    diffPS.println("Org: " + cdelta.getOriginal());
                    diffPS.println("New: " + cdelta.getRevised());
                    diffPS.println();
                } else if (delta instanceof difflib.DeleteDelta) {
                    difflib.DeleteDelta<String> ddelta = ((difflib.DeleteDelta<String>) (delta));
    ...
    private static java.util.List<String> fileToLines(java.io.File file) throws IOException {
        ...
        String line;
        java.io.BufferedReader in = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(file), TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.ENCODING));
    ...
    public void testStripByOutlineItems(int param0) throws IOException, URISyntaxException {
        ...
        String textFull = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(doc);
        assertFalse(textFull.isEmpty());
        String expectedTextFull = ((((((((((((("First level 1\n" + "First level 2\n") + "Fist level 3\n") + "Some content\n") + "Some other content\n") + "Second at level 1\n") + "Second level 2\n") + "Content\n") + "Third level 1\n") + "Third level 2\n") + "Third level 3\n") + "Content\n") + "Fourth level 1\n") + "Content\n") + "Content\n";
        assertEquals(expectedTextFull, textFull.replaceAll("\r", ""));
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setStartBookmark(oi2);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setEndBookmark(oi3);
        String textoi23 = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(doc);
        ...
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setStartBookmark(null);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setEndBookmark(null);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setStartPage(3);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setEndPage(param0);
        String textp34 = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(doc);
        assertFalse(textp34.isEmpty());
        assertNotEquals(textoi23, textFull);
        assertEquals(textoi23, textp34);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setStartBookmark(oi2);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setEndBookmark(oi2);
        String textoi2 = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(doc);
        ...
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setStartPage(3);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setEndPage(param0);
        String textp3 = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(doc);
        ...
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setStartBookmark(oiOrphan);
        TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.setEndBookmark(oiOrphan);
        String textOiOrphan = TestProzeGen_PDFTextStripper_setEndPage_int_TestTextStripper_testStripByOutlineItems.stripper.getText(doc);

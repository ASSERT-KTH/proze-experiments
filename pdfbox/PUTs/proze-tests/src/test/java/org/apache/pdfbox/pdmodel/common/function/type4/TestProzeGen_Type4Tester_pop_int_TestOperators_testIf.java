...
public class TestProzeGen_Type4Tester_pop_int_TestOperators_testIf {
    /**
    ...
    public void testIf(int param0) throws Exception {
        Type4Tester.create("true { 2 1 add } if").pop(param0).isEmpty();
        Type4Tester.create("false { 2 1 add } if").isEmpty();
        try {

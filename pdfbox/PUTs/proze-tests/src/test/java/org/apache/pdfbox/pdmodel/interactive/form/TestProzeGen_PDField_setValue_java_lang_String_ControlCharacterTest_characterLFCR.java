 ...
 */
public class TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterLFCR {
    ...
    public void setUp() throws java.io.IOException {
        document = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterLFCR.IN_DIR, TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterLFCR.NAME_OF_PDF));
    ...
    public void characterLFCR(String param0) throws java.io.IOException {
        ...
        java.util.List<String> acrobatValues = getStringsFromStream(acroForm.getField("acrobat-lfcr"));

 ...
 */
public class TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testBadPrefixSchemas {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testBadPrefixSchemas.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testBadPrefixSchemas(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testBadPrefixSchemas.sync.validateMetadataSynchronization(doc, metadata);

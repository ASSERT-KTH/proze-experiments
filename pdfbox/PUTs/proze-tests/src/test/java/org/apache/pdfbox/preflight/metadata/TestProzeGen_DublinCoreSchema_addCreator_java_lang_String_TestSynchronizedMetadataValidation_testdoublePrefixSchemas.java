 ...
 */
public class TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testdoublePrefixSchemas {
    ...
    public static void initSynchronizedMetadataValidation() {
        TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testdoublePrefixSchemas.sync = new SynchronizedMetaDataValidation();
    }
    ...
    public void testdoublePrefixSchemas(String param0) throws Exception {
        ...
        try {
            ve = TestProzeGen_DublinCoreSchema_addCreator_java_lang_String_TestSynchronizedMetadataValidation_testdoublePrefixSchemas.sync.validateMetadataSynchronization(doc, metadata);

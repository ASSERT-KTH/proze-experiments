...
public class TestProzeGen_XMPSchema_getUnqualifiedBagValueList_java_lang_String_XMPSchemaTest_testAsSimpleMethods {
    ...
    public void testAsSimpleMethods(String param0) throws Exception {
        ...
        assertTrue(schem.getUnqualifiedBagValueList(param0).contains(bagVal));

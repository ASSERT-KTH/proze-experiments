...
public class TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions {
    /**
     * Logger instance.
     */
    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.class);
    ...
    public static void setUp() throws Exception {
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.testResultsDir.mkdirs();
        ...
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission = new org.apache.pdfbox.pdmodel.encryption.AccessPermission();
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanAssembleDocument(false);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanExtractContent(false);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanExtractForAccessibility(true);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanFillInForm(false);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanModify(false);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanModifyAnnotations(false);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanPrint(true);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setCanPrintDegraded(false);
        TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.permission.setReadOnly();
    }
    ...
    private byte[] getFileResourceAsByteArray(String testFileName) throws java.io.IOException {
        return org.apache.pdfbox.io.IOUtils.toByteArray(TestProzeGen_AccessPermission_setCanPrint_boolean_TestSymmetricKeyEncryption_testPermissions.class.getResourceAsStream(testFileName));
    }

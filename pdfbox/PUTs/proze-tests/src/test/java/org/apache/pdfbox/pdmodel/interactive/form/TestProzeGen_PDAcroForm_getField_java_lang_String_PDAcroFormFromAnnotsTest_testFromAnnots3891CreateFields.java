 ...
 */
public class TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormFromAnnotsTest_testFromAnnots3891CreateFields {
    /**
    ...
    public void testFromAnnots3891CreateFields(java.lang.String param0) throws java.io.IOException {
        java.lang.String sourceUrl = "https://issues.apache.org/jira/secure/attachment/12881055/merge-test.pdf";
        java.lang.String acrobatSourceUrl = "https://issues.apache.org/jira/secure/attachment/13014447/merge-test-na-acrobat.pdf";
        int numFormFieldsByAcrobat = 0;
        // will build the expected fields using the acrobat source document
        java.util.Map<java.lang.String, org.apache.pdfbox.pdmodel.interactive.form.PDField> fieldsByName = new java.util.HashMap<java.lang.String, org.apache.pdfbox.pdmodel.interactive.form.PDField>();
        org.apache.pdfbox.pdmodel.PDDocument testPdf = null;
        try {
            testPdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.net.URL(acrobatSourceUrl).openStream());
            org.apache.pdfbox.pdmodel.PDDocumentCatalog catalog = testPdf.getDocumentCatalog();
            org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroForm = catalog.getAcroForm(null);
        ...
        try {
            ...
            org.apache.pdfbox.cos.COSDictionary cosAcroForm = ((org.apache.pdfbox.cos.COSDictionary) (catalog.getCOSObject().getDictionaryObject(org.apache.pdfbox.cos.COSName.ACRO_FORM)));
            org.apache.pdfbox.cos.COSArray cosFields = ((org.apache.pdfbox.cos.COSArray) (cosAcroForm.getDictionaryObject(org.apache.pdfbox.cos.COSName.FIELDS)));
            assertEquals(0, cosFields.size(),
                    "Initially there shall be 0 fields");
            org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroForm = catalog.getAcroForm(new org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormFromAnnotsTest_testFromAnnots3891CreateFields.CreateFieldsFixup(testPdf));
            ...
            for (java.lang.String fieldName : fieldsByName.keySet()) {
                assertNotNull(acroForm.getField(param0));
            }
        } finally {
            org.apache.pdfbox.io.IOUtils.closeQuietly(testPdf);
        }
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFromAnnots3891CreateFields_1(java.lang.String param0) throws java.io.IOException {
        java.lang.String sourceUrl = "https://issues.apache.org/jira/secure/attachment/12881055/merge-test.pdf";
        java.lang.String acrobatSourceUrl = "https://issues.apache.org/jira/secure/attachment/13014447/merge-test-na-acrobat.pdf";
        int numFormFieldsByAcrobat = 0;
        // will build the expected fields using the acrobat source document
...
//                assertNotNull(acroForm.getField(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFromAnnots3891CreateFields_2(java.lang.String param0) throws java.io.IOException {
        java.lang.String sourceUrl = "https://issues.apache.org/jira/secure/attachment/12881055/merge-test.pdf";
        java.lang.String acrobatSourceUrl = "https://issues.apache.org/jira/secure/attachment/13014447/merge-test-na-acrobat.pdf";
        int numFormFieldsByAcrobat = 0;
        // will build the expected fields using the acrobat source document
...
//                assertNotNull(acroForm.getField(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFromAnnots3891CreateFields_3(java.lang.String param0) throws java.io.IOException {
        java.lang.String sourceUrl = "https://issues.apache.org/jira/secure/attachment/12881055/merge-test.pdf";
        java.lang.String acrobatSourceUrl = "https://issues.apache.org/jira/secure/attachment/13014447/merge-test-na-acrobat.pdf";
        int numFormFieldsByAcrobat = 0;
        // will build the expected fields using the acrobat source document
...
//                assertNotNull(acroForm.getField(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFromAnnots3891CreateFields_4(java.lang.String param0) throws java.io.IOException {
        java.lang.String sourceUrl = "https://issues.apache.org/jira/secure/attachment/12881055/merge-test.pdf";
        java.lang.String acrobatSourceUrl = "https://issues.apache.org/jira/secure/attachment/13014447/merge-test-na-acrobat.pdf";
        int numFormFieldsByAcrobat = 0;
        // will build the expected fields using the acrobat source document
...
//                assertNotNull(fieldsByName.get(field.getFullyQualifiedName()));
    ...
    class CreateFieldsFixup extends org.apache.pdfbox.pdmodel.fixup.AbstractFixup {
        CreateFieldsFixup(org.apache.pdfbox.pdmodel.PDDocument document) {
            super(document);
        }

        @java.lang.Override
        public void apply() {
            new org.apache.pdfbox.pdmodel.fixup.processor.AcroFormOrphanWidgetsProcessor(document).process();
        }
    }

 ...
 */
public class TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAnnotsEntry {
    ...
    public void setUp() {
        TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAnnotsEntry.OUT_DIR.mkdirs();
    }
    ...
    public void testAnnotsEntry(String param0) throws java.io.IOException {
        ...
        try {
            java.io.File f1 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAnnotsEntry.TARGET_PDF_DIR, "PDFBOX-1031-1.pdf");
            s1 = new java.io.FileInputStream(f1);
            java.io.File f2 = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAnnotsEntry.TARGET_PDF_DIR, "PDFBOX-1031-2.pdf");
            s2 = new java.io.FileInputStream(f2);
            java.io.File pdfOutput = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testAnnotsEntry.OUT_DIR, "PDFBOX-1031.pdf");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAnnotsEntry_1(String param0) throws java.io.IOException {
        java.io.InputStream s1 = null;
        java.io.InputStream s2 = null;
        // Merge the PDFs form PDFBOX-1031
        PDFMergerUtility merger = new PDFMergerUtility();
...
//                    "There shall be 1 annotation for the second page");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAnnotsEntry_2(String param0) throws java.io.IOException {
        java.io.InputStream s1 = null;
        java.io.InputStream s2 = null;
        // Merge the PDFs form PDFBOX-1031
        PDFMergerUtility merger = new PDFMergerUtility();
...
//                    "There shall be 1 annotation for the second page");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAnnotsEntry_3(String param0) throws java.io.IOException {
        java.io.InputStream s1 = null;
        java.io.InputStream s2 = null;
        // Merge the PDFs form PDFBOX-1031
        PDFMergerUtility merger = new PDFMergerUtility();
...
//                    "There shall be 1 annotation for the second page");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAnnotsEntry_4(String param0) throws java.io.IOException {
        java.io.InputStream s1 = null;
        java.io.InputStream s2 = null;
        // Merge the PDFs form PDFBOX-1031
        PDFMergerUtility merger = new PDFMergerUtility();
...
//                    "There shall be 1 annotation for the second page");
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testAnnotsEntry_5(String param0) throws java.io.IOException {
        java.io.InputStream s1 = null;
        java.io.InputStream s2 = null;
        // Merge the PDFs form PDFBOX-1031
        PDFMergerUtility merger = new PDFMergerUtility();

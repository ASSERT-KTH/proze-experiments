 ...
 */
public class TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormTest_testFlattenSpecificFieldsOnly {
    ...
    public void testFlattenSpecificFieldsOnly(java.lang.String param0) throws java.io.IOException {
        java.io.File file = new java.io.File(org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormTest_testFlattenSpecificFieldsOnly.OUT_DIR, "AlignmentTests-flattened-specificFields.pdf");
        java.util.List<org.apache.pdfbox.pdmodel.interactive.form.PDField> fieldsToFlatten = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.form.PDField>();
        org.apache.pdfbox.pdmodel.PDDocument testPdf = null;
        try {
            testPdf = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormTest_testFlattenSpecificFieldsOnly.IN_DIR, "AlignmentTests.pdf"));
            org.apache.pdfbox.pdmodel.interactive.form.PDAcroForm acroFormToFlatten = testPdf.getDocumentCatalog().getAcroForm();
            int numFieldsBeforeFlatten = acroFormToFlatten.getFields().size();
            int numWidgetsBeforeFlatten = countWidgets(testPdf);
            fieldsToFlatten.add(acroFormToFlatten.getField(param0));
            fieldsToFlatten.add(acroFormToFlatten.getField(param0));
            fieldsToFlatten.add(acroFormToFlatten.getField(param0));
            fieldsToFlatten.add(acroFormToFlatten.getField(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFlattenSpecificFieldsOnly_1(java.lang.String param0) throws java.io.IOException {
        java.io.File file = new java.io.File(org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormTest_testFlattenSpecificFieldsOnly.OUT_DIR, "AlignmentTests-flattened-specificFields.pdf");
        java.util.List<org.apache.pdfbox.pdmodel.interactive.form.PDField> fieldsToFlatten = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.form.PDField>();
        org.apache.pdfbox.pdmodel.PDDocument testPdf = null;
        try {
...
//            assertEquals(numWidgetsBeforeFlatten, numWidgetsAfterFlatten + fieldsToFlatten.size());
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testFlattenSpecificFieldsOnly_2(java.lang.String param0) throws java.io.IOException {
        java.io.File file = new java.io.File(org.apache.pdfbox.pdmodel.interactive.form.TestProzeGen_PDAcroForm_getField_java_lang_String_PDAcroFormTest_testFlattenSpecificFieldsOnly.OUT_DIR, "AlignmentTests-flattened-specificFields.pdf");
        java.util.List<org.apache.pdfbox.pdmodel.interactive.form.PDField> fieldsToFlatten = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.form.PDField>();
        org.apache.pdfbox.pdmodel.PDDocument testPdf = null;
        try {
...
//            assertEquals(numFieldsBeforeFlatten, numFieldsAfterFlatten + fieldsToFlatten.size());
    ...
    private int countWidgets(org.apache.pdfbox.pdmodel.PDDocument documentToTest) {
        int count = 0;
        for (org.apache.pdfbox.pdmodel.PDPage page : documentToTest.getPages()) {
            try {
                for (org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation annotation : page.getAnnotations()) {
                    if (annotation instanceof org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotationWidget) {
                        count++;
                    }
                }

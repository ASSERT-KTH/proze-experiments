 ...
 */
public class TestProzeGen_COSName_getPDFName_java_lang_String_PDFontTest_testPDFox5048 {
    private static final java.io.File OUT_DIR = new java.io.File("target/test-output");

    @org.junit.jupiter.api.BeforeEach
    public void setUp() throws Exception {
        TestProzeGen_COSName_getPDFName_java_lang_String_PDFontTest_testPDFox5048.OUT_DIR.mkdirs();
    }
    ...
    public void testPDFox5048(String param0) throws IOException {
        ...
        PDFont font = page.getResources().getFont(org.apache.pdfbox.cos.COSName.getPDFName(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFox5048_1(String param0) throws IOException {
        java.io.InputStream is = new java.net.URL("https://issues.apache.org/jira/secure/attachment/13017227/stringwidth.pdf").openStream();
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(is);
        org.apache.pdfbox.pdmodel.PDPage page = doc.getPage(0);
        PDFont font = page.getResources().getFont(org.apache.pdfbox.cos.COSName.getPDFName(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFox5048_2(String param0) throws IOException {
        java.io.InputStream is = new java.net.URL("https://issues.apache.org/jira/secure/attachment/13017227/stringwidth.pdf").openStream();
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(is);
        org.apache.pdfbox.pdmodel.PDPage page = doc.getPage(0);
        PDFont font = page.getResources().getFont(org.apache.pdfbox.cos.COSName.getPDFName(param0));
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testPDFox5048_3(String param0) throws IOException {
        java.io.InputStream is = new java.net.URL("https://issues.apache.org/jira/secure/attachment/13017227/stringwidth.pdf").openStream();
        org.apache.pdfbox.pdmodel.PDDocument doc = org.apache.pdfbox.pdmodel.PDDocument.load(is);
        org.apache.pdfbox.pdmodel.PDPage page = doc.getPage(0);
        PDFont font = page.getResources().getFont(org.apache.pdfbox.cos.COSName.getPDFName(param0));

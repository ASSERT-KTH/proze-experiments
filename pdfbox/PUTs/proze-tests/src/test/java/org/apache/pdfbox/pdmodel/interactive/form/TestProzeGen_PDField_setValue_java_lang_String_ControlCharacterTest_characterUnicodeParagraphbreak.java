 ...
 */
public class TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterUnicodeParagraphbreak {
    ...
    public void setUp() throws java.io.IOException {
        document = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterUnicodeParagraphbreak.IN_DIR, TestProzeGen_PDField_setValue_java_lang_String_ControlCharacterTest_characterUnicodeParagraphbreak.NAME_OF_PDF));
    ...
    public void characterUnicodeParagraphbreak(String param0) throws java.io.IOException {
        ...
        java.util.List<String> acrobatValues = getStringsFromStream(acroForm.getField("acrobat-paragraphbreak"));

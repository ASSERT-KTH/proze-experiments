...
public class TestProzeGen_XMPSchema_getIntegerProperty_java_lang_String_XMPSchemaTest_testAsSimpleMethods {
    ...
    public void testAsSimpleMethods(String param0) throws Exception {
        ...
        assertEquals("" + i, schem.getIntegerProperty(param0).getStringValue());
...
//        assertTrue(schem.getUnqualifiedLanguagePropertyLanguagesValue(langprop).contains(lang));
    ...
    private static java.util.stream.Stream<org.junit.jupiter.params.provider.Arguments> provideProzeArguments() {
        ...
        org.junit.jupiter.params.provider.Arguments.of("integer"),
        org.junit.jupiter.params.provider.Arguments.of("boolType")
        );
    }
}
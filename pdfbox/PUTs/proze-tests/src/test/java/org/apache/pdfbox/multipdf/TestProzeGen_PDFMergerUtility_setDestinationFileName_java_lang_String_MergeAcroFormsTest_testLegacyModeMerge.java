 ...
 */
public class TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testLegacyModeMerge {
    ...
    public void setUp() {
        TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testLegacyModeMerge.OUT_DIR.mkdirs();
    }
    ...
    public void testLegacyModeMerge(String param0) throws java.io.IOException {
        ...
        java.io.File toBeMerged = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testLegacyModeMerge.IN_DIR, "AcroFormForMerge.pdf");
        java.io.File pdfOutput = new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testLegacyModeMerge.OUT_DIR, "PDFBoxLegacyMerge-SameMerged.pdf");
        ...
        try {
            compliantDocument = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testLegacyModeMerge.IN_DIR, "PDFBoxLegacyMerge-SameMerged.pdf"));
            toBeCompared = org.apache.pdfbox.pdmodel.PDDocument.load(new java.io.File(TestProzeGen_PDFMergerUtility_setDestinationFileName_java_lang_String_MergeAcroFormsTest_testLegacyModeMerge.OUT_DIR, "PDFBoxLegacyMerge-SameMerged.pdf"));

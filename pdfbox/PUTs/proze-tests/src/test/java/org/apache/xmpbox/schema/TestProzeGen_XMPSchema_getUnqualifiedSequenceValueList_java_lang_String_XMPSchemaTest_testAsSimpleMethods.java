...
public class TestProzeGen_XMPSchema_getUnqualifiedSequenceValueList_java_lang_String_XMPSchemaTest_testAsSimpleMethods {
    ...
    public void testAsSimpleMethods(String param0) throws Exception {
        ...
        assertTrue(schem.getUnqualifiedSequenceValueList(param0).contains(seqPropVal));

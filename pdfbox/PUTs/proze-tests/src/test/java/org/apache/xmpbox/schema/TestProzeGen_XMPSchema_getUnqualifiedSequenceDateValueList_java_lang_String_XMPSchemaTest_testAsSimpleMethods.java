...
public class TestProzeGen_XMPSchema_getUnqualifiedSequenceDateValueList_java_lang_String_XMPSchemaTest_testAsSimpleMethods {
    ...
    public void testAsSimpleMethods(String param0) throws Exception {
        ...
        assertTrue(schem.getUnqualifiedSequenceDateValueList(param0).contains(dateVal));
...
//        assertTrue(schem.getUnqualifiedLanguagePropertyLanguagesValue(langprop).contains(lang));
    ...
    private static java.util.stream.Stream<org.junit.jupiter.params.provider.Arguments> provideProzeArguments() {
        ...
        org.junit.jupiter.params.provider.Arguments.of("SeqDate"),

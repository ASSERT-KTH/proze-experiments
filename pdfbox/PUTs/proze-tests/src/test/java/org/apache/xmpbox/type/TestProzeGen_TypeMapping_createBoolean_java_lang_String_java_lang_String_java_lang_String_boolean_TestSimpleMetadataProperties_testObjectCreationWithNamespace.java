 ...
 * @author a183132
 */
public class TestProzeGen_TypeMapping_createBoolean_java_lang_String_java_lang_String_java_lang_String_boolean_TestSimpleMetadataProperties_testObjectCreationWithNamespace {
    ...
    public void testObjectCreationWithNamespace(String param0, String param1, String param2, boolean param3) throws Exception {
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testObjectCreationWithNamespace_1(String param0, String param1, String param2, boolean param3) throws Exception {
        String ns = "http://www.test.org/pdfa/";
        BooleanType bool = parent.getTypeMapping().createBoolean(param0, param1, param2, param3);
        DateType date = parent.getTypeMapping().createDate(ns, "test", "date", java.util.Calendar.getInstance());
        IntegerType integer = parent.getTypeMapping().createInteger(ns, "test", "integer", 1);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testObjectCreationWithNamespace_2(String param0, String param1, String param2, boolean param3) throws Exception {
        String ns = "http://www.test.org/pdfa/";
        BooleanType bool = parent.getTypeMapping().createBoolean(param0, param1, param2, param3);
        DateType date = parent.getTypeMapping().createDate(ns, "test", "date", java.util.Calendar.getInstance());
        IntegerType integer = parent.getTypeMapping().createInteger(ns, "test", "integer", 1);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testObjectCreationWithNamespace_3(String param0, String param1, String param2, boolean param3) throws Exception {
        String ns = "http://www.test.org/pdfa/";
        BooleanType bool = parent.getTypeMapping().createBoolean(param0, param1, param2, param3);
        DateType date = parent.getTypeMapping().createDate(ns, "test", "date", java.util.Calendar.getInstance());
        IntegerType integer = parent.getTypeMapping().createInteger(ns, "test", "integer", 1);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testObjectCreationWithNamespace_4(String param0, String param1, String param2, boolean param3) throws Exception {
        String ns = "http://www.test.org/pdfa/";
        BooleanType bool = parent.getTypeMapping().createBoolean(param0, param1, param2, param3);
        DateType date = parent.getTypeMapping().createDate(ns, "test", "date", java.util.Calendar.getInstance());
        IntegerType integer = parent.getTypeMapping().createInteger(ns, "test", "integer", 1);
    ...
    @org.junit.jupiter.params.ParameterizedTest
    @org.junit.jupiter.params.provider.MethodSource("provideProzeArguments")
    public void testObjectCreationWithNamespace_5(String param0, String param1, String param2, boolean param3) throws Exception {
        String ns = "http://www.test.org/pdfa/";
        BooleanType bool = parent.getTypeMapping().createBoolean(param0, param1, param2, param3);
        DateType date = parent.getTypeMapping().createDate(ns, "test", "date", java.util.Calendar.getInstance());
        IntegerType integer = parent.getTypeMapping().createInteger(ns, "test", "integer", 1);

 ...
 */
public class TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL {
    ...
    private static final String keystorePath = TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.inDir + "keystore.p12";

    private static final String jpegPath = TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.inDir + "stamp.jpg";
    ...
    public static void init() throws Exception {
        ...
        TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.certificateFactory = java.security.cert.CertificateFactory.getInstance("X.509");
        // load the keystore
        TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.keyStore = java.security.KeyStore.getInstance("PKCS12");
        TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.keyStore.load(new java.io.FileInputStream(TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.keystorePath), TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.password.toCharArray());
        new java.io.File("target/test-output").mkdirs();
        TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.certificate = TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.keyStore.getCertificateChain(TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.keyStore.aliases().nextElement())[0];
        TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.tsa = System.getProperty("org.apache.pdfbox.examples.pdmodel.tsa");
    }
    ...
    public void testCRL(String param0) throws IOException, CMSException, CertificateException, TSPException, OperatorCreationException, CertificateVerificationException, NoSuchAlgorithmException {
        if (externallySign) {
            return;// runs only once, independent of externallySign

        }
        String hexSignature;
        java.io.BufferedReader bfr = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(TestProzeGen_Hex_decodeHex_java_lang_String_TestCreateSignature_testCRL.inDir + "hexsignature.txt")));
        hexSignature = bfr.readLine();
        bfr.close();
        org.bouncycastle.cms.CMSSignedData signedData = new org.bouncycastle.cms.CMSSignedData(org.apache.pdfbox.util.Hex.decodeHex(param0));
        ...
        org.bouncycastle.util.Store<org.bouncycastle.cert.X509CertificateHolder> certificatesStore = signedData.getCertificates();
        // SignerInformation.getSID() is untyped
        @SuppressWarnings("unchecked")
        java.util.Collection<org.bouncycastle.cert.X509CertificateHolder> matches = certificatesStore.getMatches(signerInformation.getSID());
        org.bouncycastle.cert.X509CertificateHolder certificateHolder = matches.iterator().next();
        java.security.cert.X509Certificate certFromSignedData = new org.bouncycastle.cert.jcajce.JcaX509CertificateConverter().getCertificate(certificateHolder);
        org.apache.pdfbox.examples.signature.SigUtils.checkCertificateUsage(certFromSignedData);
        ...
        org.bouncycastle.cert.X509CertificateHolder tstCertHolder = tstMatches.iterator().next();
        java.security.cert.X509Certificate certFromTimeStamp = new org.bouncycastle.cert.jcajce.JcaX509CertificateConverter().getCertificate(tstCertHolder);
        // merge both stores using a set to remove duplicates
        java.util.HashSet<org.bouncycastle.cert.X509CertificateHolder> certificateHolderSet = new java.util.HashSet<org.bouncycastle.cert.X509CertificateHolder>();
        ...
        org.apache.pdfbox.examples.signature.SigUtils.verifyCertificateChain(new org.bouncycastle.util.CollectionStore<org.bouncycastle.cert.X509CertificateHolder>(certificateHolderSet), certFromTimeStamp, timeStampToken.getTimeStampInfo().getGenTime());
        ...
        org.apache.pdfbox.examples.signature.SigUtils.verifyCertificateChain(certificatesStore, certFromSignedData, timeStampToken.getTimeStampInfo().getGenTime());
    }

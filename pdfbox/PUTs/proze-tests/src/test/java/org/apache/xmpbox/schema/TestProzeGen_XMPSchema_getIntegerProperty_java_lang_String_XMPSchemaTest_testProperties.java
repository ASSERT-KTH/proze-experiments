...
public class TestProzeGen_XMPSchema_getIntegerProperty_java_lang_String_XMPSchemaTest_testProperties {
    ...
    public void testProperties(String param0) throws Exception {
        ...
        assertEquals(intType, schem.getIntegerProperty(param0));
        boolean ok = false;
        try {
            schem.getIntegerProperty(param0);

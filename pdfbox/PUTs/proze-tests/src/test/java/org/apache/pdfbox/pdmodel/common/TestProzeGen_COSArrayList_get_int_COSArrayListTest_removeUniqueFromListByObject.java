...
public class TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject {
    ...
    public void setUp() throws Exception {
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        ...
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList = new java.util.ArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray = new org.apache.pdfbox.cos.COSArray();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.add(txtMark);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.add(txtLink);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.add(aCircle);
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.add(txtLink);
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.size());
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray = new org.apache.pdfbox.cos.COSBase[4];
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[0] = txtMark.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[1] = txtLink.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[2] = aCircle.getCOSObject();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[3] = txtLink.getCOSObject();
        assertEquals(4, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray.length);
        // add the annotations to the page
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.pdPage = new org.apache.pdfbox.pdmodel.PDPage();
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.pdPage.setAnnotations(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList);
        // create test output directory
        TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.OUT_DIR.mkdirs();
    }
    ...
    public void removeUniqueFromListByObject(int param0) throws Exception {
        COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation> cosArrayList = new COSArrayList<org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation>(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray);
        int positionToRemove = 2;
        org.apache.pdfbox.pdmodel.interactive.annotation.PDAnnotation toBeRemoved = TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsList.get(positionToRemove);
        ...
        assertEquals(3, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.size(),
                "COSArray size shall be 3");
        assertEquals(cosArrayList.get(param0), TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.get(3),
                "List object at 3 is at position 2 in COSArrayList now");
        assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.get(2), TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.get(3).getCOSObject(),
                "COSObject of List object at 3 is at position 2 in COSArray now");
        assertEquals(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.get(2), TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[3],
                "Array object at 3 is at position 2 in underlying COSArray now");
        assertEquals(-1, cosArrayList.indexOf(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.get(positionToRemove)),
                "PDAnnotation shall no longer exist in List");
        assertEquals(-1, TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.indexOf(TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[positionToRemove]),
    ...
    public void removeUniqueFromListByObject_1(int param0) throws Exception {
        ...
        // assertEquals("COSArray size shall be 3", 3, org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.size());
        // assertEquals("List object at 3 is at position 2 in COSArrayList now", cosArrayList.get(2), org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.get(3));
        // assertEquals("COSObject of List object at 3 is at position 2 in COSArray now", org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.get(2), org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.get(3).getCOSObject());
        // assertEquals("Array object at 3 is at position 2 in underlying COSArray now", org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.get(2), org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[3]);
        // assertEquals("PDAnnotation shall no longer exist in List", -1, cosArrayList.indexOf(org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsList.get(positionToRemove)));
        // assertEquals("COSObject shall no longer exist in COSArray", -1, org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.annotationsArray.indexOf(org.apache.pdfbox.pdmodel.common.TestProzeGen_COSArrayList_get_int_COSArrayListTest_removeUniqueFromListByObject.tbcAnnotationsArray[positionToRemove]));
